            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="breadcrumb_content style2">
                        <h2 class="breadcrumb_title">{{ __('Payment') }}</h2>
            ...
            <div class="row">
                                        ...
                                        <div class="col-12 col-lg col-md-4 text-right">
                                            ...
                                            <form class="w3-container w3-display-middle w3-card-4" method="POST" action="{{ route('user.cod',$store->slug) }}">
                                                ...
                                                <div class="form-group">
                                                    <button type="button" class="btn btn-thm btn-block" id="cash_on_delivery">{{__('Pay Now')}}</button>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-4 col-md-4 col-sm-12 text-right">
                                            ...
                                            <form class="w3-container w3-display-middle w3-card-4" method="POST" action="{{ route('user.telegram',$store->slug) }}">
                                                ...
                                                <div class="form-group mt-3">
                                                    <button type="button" class="btn btn-thm btn-block" id="owner-telegram">{{__('Pay Now')}}</button>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 col-md-4 col-sm-12 text-right">
                                            ...
                                            <form class="w3-container w3-display-middle w3-card-4" method="POST" action="{{ route('user.whatsapp',$store->slug) }}">
                                                ...
                                                <input type="hidden" name="product_id">
                                                <div class="form-group mt-3">
                                                    <button type="button" class="btn btn-thm btn-block" id="owner-whatsapp">{{__('Pay Now')}}</button>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-5 col-md-5 col-sm-12 text-right">
                                            ...
                                            <form class="w3-container w3-display-middle w3-card-4" method="POST" action="{{ route('user.bank_transfer',$store->slug) }}">
                                                ...
                                                <input type="hidden" name="product_id">
                                                <div class="form-group mt-3">
                                                    <button type="button" class="btn btn-thm btn-block" id="bank_transfer">{{__('Pay Now')}}</button>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-lg-4 col-md-4 text-right">
                                            ...
                                            <form class="w3-container w3-display-middle w3-card-4" method="POST" action="{{ route('paytm.prepare.payments',$store->slug) }}">
                                                ...
                                                <div class="form-group mt-3">
                                                    <div class="text-sm-right ">
                                                        <button type="submit" class="btn btn-thm btn-block">{{__('Pay Now')}}</button>
                                                    </div>
                                                </div>
                                            </form>
                                        </div>
                                ...
                                <div class="card-header">
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-lg-4 col-md-4 text-right">
                                            ...
                                            <div class="form-group mt-3">
                                                <div class="text-sm-right ">
                                                    <button type="button" class="btn btn-thm btn-block" onclick="payMercado()">{{__('Pay Now')}}</button>
                                                </div>
                                            </div>
                ...
                <div class="col-lg-4">
                    ...
                    <div class="order_sidebar_widget mb30">
                        <h4 class="title">{{ __('Summary') }} ({{$total_item}} items)</h4>
