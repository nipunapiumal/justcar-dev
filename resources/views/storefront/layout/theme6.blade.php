...
<body class="{{ $body_home_style }}">
    ...
    <div class="wrapper ovh">
        ...
        @if ($storethemesetting['enable_top_bar'] == 'on')
            <!-- header top -->
            <div class="header_top {{ $style_top_header }} dn-992">
                <div class="{{ $store->theme_dir == 'theme7' ? 'container-fluid' : 'container posr' }}">
                    <div class="row">
            ...
            <header class="header-nav menu_style_home_one {{ $style_header }} transparent  main-menu">
                ...
                <nav>
                    <div class="container posr">
                        ...
                        <a href="{{ route('store.slug', $store->slug) }}" class="navbar_brand float-start dn-lg">
                            @if (!empty($store->logo))
                        ...
                        <ul id="respMenu2" class="ace-responsive-menu header-menu-widgets float-start wa"
                            ...
                            @if (Utility::CustomerAuthCheck($store->slug) != true)
                                ...
                                <li><a href="#">|</a></li>
                                <li><a href="{{ route('store.usercreate', $store->slug) }}">{{ __('Register') }}</a>
                                </li>
                            @else
                                <li class="list_c">
                                    <a href="#"
        ...
        <!-- Our Footer -->
        <section class="footer_one {{ $footer_style }}  pt50 pb25">
            <div class="container">
                <div class="row">
                    ...
                    @if (isset($storethemesetting['enable_quick_link4']) && $storethemesetting['enable_quick_link4'] == 'on')
                        <div class="col-md-8 col-xl-5">
                            <div class="footer_menu_widget {{ $footer_style_1 }} text-start text-md-end mt15">
                                <ul>
                ...
                <div class="row">
                    @if (isset($storethemesetting['enable_quick_link1']) && $storethemesetting['enable_quick_link1'] == 'on')
                        <div class="col-sm-6 col-md-4 col-lg-3 col-xl-3">
                            <div class="footer_about_widget {{ $footer_style_1 }}">
                    ...
                    @if (isset($storethemesetting['enable_email_subscriber']) && $storethemesetting['enable_email_subscriber'] == 'on')
                        @if ($storethemesetting['enable_email_subscriber'] == 'on')
                            <div class="col-sm-6 col-md-6 col-lg-3 col-xl-3">
                                <div class="footer_contact_widget {{ $footer_style_contact_widget }}">
                                    <h5 class="title">
                                        {{ !empty($storethemesetting['subscriber_title']) ? $storethemesetting['subscriber_title'] : 'Always on time' }}
                                    </h5>
                                    {{ Form::open(['route' => ['subscriptions.store_email', $store->id], 'method' => 'POST', 'class' => 'footer_mailchimp_form ' . $footer_mailchimp_form . '']) }}
                                    <div class="wrapper">
                                        <div class="col-auto">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-6 col-lg-8 col-xl-9">
                            <div class="copyright-widget {{ $footer_style_1 }} mt5 text-start mb20-sm">
                                <p>
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="footer_social_widget {{ $footer_style_1 }} text-start text-md-end">
                                <ul class="mb0">
