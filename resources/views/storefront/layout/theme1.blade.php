            ...
            <div class="container px-lg-0">
                ...
                <a class="navbar-brand mr-lg-5" href="{{ route('store.slug', $store->slug) }}">
                    @if (!empty($store->logo_dark))
                        <img alt="Image placeholder"
                            src="{{ asset(Storage::url('uploads/store_logo/' . $store->logo_dark)) }}" id="navbar-logo"
                            style="height: 40px;">
                    @else
                ...
                <div class="collapse navbar-collapse" id="navbar-main-collapse">
                    <ul class="navbar-nav align-items-lg-center">
                        <!-- Home - Overview  -->
                        <li class="nav-item ">
                            <a class="nav-link" href="{{ route('store.slug', $store->slug) }}">{{ __('Home') }}</a>
                        </li>
                        ...
                        <li class="nav-item ">
                            <a class="nav-link"
                                href="{{ route('store.contact', $store->slug) }}">{{ __('Contact Us') }}</a>
                        </li>
                        {{-- @if (isset($storethemesetting['enable_gallery']) && $storethemesetting['enable_gallery'] == 'on')
                            <li class="nav-item">
                                <a class="nav-link"
                                    href="{{ route('store.gallery', [$store->slug]) }}">{{ __('Gallery') }}</a>
                            </li>
                        @endif
                        @if (
                            $plan->job_board == 'on' &&
                    ...
                    <ul class="navbar-nav align-items-lg-center ml-lg-auto nav-my-store">
                        ...
                        <a href="{{route('store.cart',$store->slug)}}" class="nav-heart btn btn-primary ml-2 mr-2 rounded-pill hover-translate-y-n3 ">
                            ...
                            <p class="badge badge-pill badge-floating bg-green border-dark shopping_count" id="shopping_count">
                ...
                @if ($storethemesetting['enable_footer_note'] == 'on')
                    <div class="row pt-md top-footer delimiter-top">
                        ...
                        @if (isset($storethemesetting['enable_quick_link1']) && $storethemesetting['enable_quick_link1'] == 'on')
                            <div class="col-lg-2 col-md-3 col-6 col-sm-6 col-6 col-sm-4 ml-lg-auto mb-5 mb-lg-0">
                                <h6 class="heading mb-3 text-primary">
                                    {{ __($storethemesetting['quick_link_header_name1']) }}</h6>
                        ...
                        @if (isset($storethemesetting['enable_quick_link2']) && $storethemesetting['enable_quick_link2'] == 'on')
                            <div class="col-lg-2 col-md-3 col-6 col-sm-6 col-6 col-sm-4 ml-lg-auto mb-5 mb-lg-0">
                                <h6 class="heading mb-3 text-primary">
                                    {{ __($storethemesetting['quick_link_header_name2']) }}</h6>
                                <ul class="list-unstyled f-list">
                                    <li><a class="t-gray" target="_blank"
                        ...
                        @if (isset($storethemesetting['enable_quick_link4']) && $storethemesetting['enable_quick_link4'] == 'on')
                            <div class="col-lg-2 col-md-3 col-6 col-sm-6 col-6 col-sm-4 ml-lg-auto mb-5 mb-lg-0">
                                <h6 class="heading mb-3 text-primary">
                                    {{ __($storethemesetting['quick_link_header_name4']) }}</h6>
                                <ul class="list-unstyled f-list">
                                    <li><a class="t-gray" target="_blank"
                        ...
                        <div class="col-md-6 footer-social">
                            <ul class="nav justify-content-center justify-content-md-end mt-3 mt-md-0">
                                ...
                                @if (!empty($storethemesetting['facebook']))
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{ $storethemesetting['facebook'] }}"
                                            target="_blank">
                                ...
                                @if (!empty($storethemesetting['twitter']))
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{ $storethemesetting['twitter'] }}"
                                            target="_blank">
                                            <i class="fab fa-twitter-square"></i>
                                        </a>
                                    </li>
                                ...
                                @if (!empty($storethemesetting['instagram']))
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{ $storethemesetting['instagram'] }}"
                                            target="_blank">
                                            <i class="fab fa-instagram"></i>
                                        </a>
                                    </li>
                                ...
                                @if (!empty($storethemesetting['youtube']))
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{ $storethemesetting['youtube'] }}"
                                            target="_blank">
