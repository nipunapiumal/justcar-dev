...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/theme6/css/custom.css?v=3') }}">
    @stack('css-page')
...
<body>
    @php
        $style_header = 'home6_style';
        $style_topbar = '';

        if (Request::segment(3) == 'categorie'):
            $style_header = 'home3_style';
            $style_topbar = 'home3_style';
        endif;
    ...
    <div class="wrapper ovh">
        ...
        @if ($storethemesetting['enable_top_bar'] == 'on')
            <!-- header top -->
            <div class="header_top {{ $style_topbar }} dn-992">
                <div class="container">
                    <div class="row">
                            ...
                            <div class="header_top_contact_opening_widget text-center text-md-start">
                                <ul class="mb0">
                                    <li class="list-inline-item"><a
                                            href="tel:{{ !empty($storethemesetting['top_bar_number']) ? $storethemesetting['top_bar_number'] : '2123081220' }}"><span
                                                class="flaticon-phone-call"></span>{{ !empty($storethemesetting['top_bar_number']) ? $storethemesetting['top_bar_number'] : '2123081220' }}</a>
                                    </li>
                            ...
                            <div class="header_top_social_widgets text-center text-md-end">
                                <ul class="m0">
                                    ...
                                    <li class="list-inline-item">
                                        ...
                                        {{-- <a href="#" data-bs-toggle="modal" data-bs-target="#languageModal"><i
                                                class="fas fa-language"></i> {{ Str::upper($currantLang) }}</a> --}}
                                        {{-- <a href="{{ route('customer.login', $store->slug) }}">{{ __('Log in') }}</a> --}}
                                    </li>
                                </ul>
                            </div>
        ...
        <!-- Main Header Nav -->
        <header class="header-nav menu_style_home_one {{ $style_header }} transparent main-menu">
            <!-- Ace Responsive Menu -->
            <nav>
                <div class="container">
                    <!-- Menu Toggle btn-->
                    ...
                    <ul id="respMenu" class="ace-responsive-menu text-end" data-menu-style="horizontal">
                            ...
                            @if ($plan->job_board == 'on' && isset($storethemesetting['enable_job_board']) && $storethemesetting['enable_job_board'] == 'on')
                                <li class="nav-item">
                                    <a style="border-radius: 6px;"
                                        class="nav-link btn  ml-2 bg--gray hover-translate-y-n3 icon-font"
                                        href="{{ route('store.job-board', [$store->slug]) }}">
                                        {{ __('Career With Us') }}
                                    </a>
                                </li>
                            @endif --}}
                                ...
                                @if ($page_slug_url->enable_page_header == 'on')
                                    <li>
                                        <a href="{{ env('APP_URL') . '/page/' . $page_slug_url->slug }}">
                                            <span class="title">{{ ucfirst($page_slug_url->name) }}</span>
                                        </a>
                                    </li>
                                @endif
                            @endforeach
                        ...
                        @endif
                        @if (Utility::CustomerAuthCheck($store->slug) != true)
                            <li><a href="{{ route('customer.login', $store->slug) }}">{{ __('Log in') }}</a></li>
                            <li class="add_listing"><a
                                    href="{{ route('store.usercreate', $store->slug) }}">{{ __('Register') }}</a>
                            </li>
                        @else
        ...
        <div id="page" class="stylehome1 h0">
            ...
            <nav id="menu" class="stylehome1">
                <ul>
                    ...
                    {{-- @foreach (json_decode($storethemesetting['sortable_nav_menu']) as $menu_title)
                        ...
                        @else
                            @if ($menu_title == 'Blog' && $store['blog_enable'] == 'on' && !empty($blog))
                                <li>
                                    <a href="{{ route('store.blog', $store->slug) }}">
                                        <span class="title">{{ __($menu_title) }}</span>
                                    </a>
                                </li>
                            @elseif($menu_title == 'Contact Us')
                                <li>
                                    <a href="{{ route('store.contact', $store->slug) }}"
                                        style="border-radius: 6px;">{{ __($menu_title) }}</a>
                                </li>
                            @elseif(
                                $menu_title == 'Gallery' &&
                    ...
                    @if ($plan->job_board == 'on' && isset($storethemesetting['enable_job_board']) && $storethemesetting['enable_job_board'] == 'on')
                        <li>
                            <a style="border-radius: 6px;" href="{{ route('store.job-board', [$store->slug]) }}">
                                {{ __('Career With Us') }}
                            </a>
                        </li>
                    @endif --}}
                        ...
                        <div class="col-md-8 col-xl-5">
                            <div class="footer_menu_widget text-start text-md-end mt15">
                                <ul>
                                    ...
                                    {{-- <li class="list-inline-item">
                                        <a class="t-gray" target="_blank"
                                            href="{{ $storethemesetting['quick_link_url41'] }}">{{ __($storethemesetting['quick_link_name41']) }}</a>
                                    </li>
                                    <li class="list-inline-item">
                                        <a class="t-gray" target="_blank"
                                            href="{{ $storethemesetting['quick_link_url42'] }}">{{ __($storethemesetting['quick_link_name42']) }}</a>
                                    </li>
                                    <li class="list-inline-item">
                                        <a class="t-gray" target="_blank"
                                            href="{{ $storethemesetting['quick_link_url43'] }}">{{ __($storethemesetting['quick_link_name43']) }}</a>
                                    </li>
                                    <li class="list-inline-item">
                                        <a class="t-gray" target="_blank"
                                            href="{{ $storethemesetting['quick_link_url44'] }}">{{ __($storethemesetting['quick_link_name44']) }}</a>
                                    </li> --}}
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 col-xl-3">
                            <div class="footer_about_widget">
                                ...
                                @if (isset($storethemesetting['footer_menu_1']) && $storethemesetting['footer_menu_1'])
                                    ...
                                    @endforeach
                                @endif
                                {{-- <p><a class="t-gray" target="_blank"
                                        href="{{ $storethemesetting['quick_link_url11'] }}">{{ __($storethemesetting['quick_link_name11']) }}</a>
                                </p>
                                <p><a class="t-gray" target="_blank"
                    ...
                    @if (isset($storethemesetting['enable_quick_link2']) && $storethemesetting['enable_quick_link2'] == 'on')
                        <div class="col-sm-6 col-md-4 col-lg-3 col-xl-3">
                            <div class="footer_about_widget">
                                ...
                                @endif
                                {{-- <p><a class="t-gray" target="_blank"
                                        href="{{ $storethemesetting['quick_link_url21'] }}">{{ __($storethemesetting['quick_link_name21']) }}</a>
                                </p>
                                <p><a class="t-gray" target="_blank"
                                        href="{{ $storethemesetting['quick_link_url22'] }}">{{ __($storethemesetting['quick_link_name22']) }}</a>
                                </p>
                                <p><a class="t-gray" target="_blank"
                                        href="{{ $storethemesetting['quick_link_url23'] }}">{{ __($storethemesetting['quick_link_name23']) }}</a>
                                </p>
                                <p><a class="t-gray" target="_blank"
                                        href="{{ $storethemesetting['quick_link_url24'] }}">{{ __($storethemesetting['quick_link_name24']) }}</a>
                                </p> --}}
                            </div>
                        </div>
                    @endif
                    @if (isset($storethemesetting['enable_quick_link3']) && $storethemesetting['enable_quick_link3'] == 'on')
                        <div class="col-sm-6 col-md-4 col-lg-3 col-xl-3">
                            <div class="footer_about_widget">
                                ...
                                @endif
                                {{-- <p><a class="t-gray" target="_blank"
                                        href="{{ $storethemesetting['quick_link_url31'] }}">{{ __($storethemesetting['quick_link_name31']) }}</a>
                                </p>
                                <p><a class="t-gray" target="_blank"
                                        href="{{ $storethemesetting['quick_link_url32'] }}">{{ __($storethemesetting['quick_link_name32']) }}</a>
                                </p>
                                <p><a class="t-gray" target="_blank"
                                        href="{{ $storethemesetting['quick_link_url33'] }}">{{ __($storethemesetting['quick_link_name33']) }}</a>
                                </p>
                                <p><a class="t-gray" target="_blank"
                                        href="{{ $storethemesetting['quick_link_url34'] }}">{{ __($storethemesetting['quick_link_name34']) }}</a>
                                </p> --}}
                            </div>
                        </div>
                    @endif
