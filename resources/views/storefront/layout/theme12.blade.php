        ...
        <header class="header-nav menu_style_home_one home7_style transparent main-menu">
            ...
            <nav>
                <div class="container-fluid">
                    ...
                    <ul id="respMenu3" class="ace-responsive-menu menu_list_custom_code wa float-start mr30"
                        data-menu-style="horizontal">
                        @if ($storethemesetting['enable_sidebar_panel'] == 'on')
                            <li class="sidebar_panel"><a class="sidebar_switch pt-3" href="#"><span></span></a>
                            </li>
                        @endif
                    </ul>
                    <!-- Logo -->
                    <a href="{{ route('store.slug', $store->slug) }}" class="navbar_brand float-start dn-md me-4">
                        @if (!empty($store->logo))
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-xl-5">
                                    <div class="footer_social_widget">
                                        {{ Form::open(['route' => ['subscriptions.store_email', $store->id], 'method' => 'POST', 'class' => 'footer_mailchimp_form home2 home7_style']) }}
                                        <div class="row align-items-center">
                                            <div class="col-auto">
                                                ...
                                                <button class="btn-thm" type="submit">{{ __('Subscribe') }}</button>
                                            </div>
                                        </div>
                                        {{ Form::close() }}
                                    </div>
                ...
                <div class="row">
                    ...
                    @if (isset($storethemesetting['enable_quick_link4']) && $storethemesetting['enable_quick_link4'] == 'on')
                        <div class="col-md-8 col-xl-5">
                            <div class="footer_menu_widget home2 text-start text-md-end mt15">
                                <ul>
