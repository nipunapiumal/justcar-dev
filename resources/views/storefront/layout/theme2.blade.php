                    ...
                    <ul class="navbar-nav align-items-lg-center ml-lg-auto nav-my-store">
                        ...
                        <li class="nav-item store-bg">
                            <a href="{{ route('store.cart', $store->slug) }}"
                                ...
                                <p class="badge badge-pill badge-floating bg-green border-dark shopping_count"
                                    id="shopping_count">
                        ...
                        <div class="col-lg-6 mb-5 mb-lg-0">
                            <a href="{{ route('store.slug', $store->slug) }}">
                                @if (
                                    ...
                                    <img class="mb-3"
                                        src="{{ asset(Storage::url('uploads/store_logo/' . $storethemesetting['footer_logo'])) }}"
                            ...
                            <div class="get-qus">
                                ...
                                <div>
                                    ...
                                    <a
                                        href="tel:{{ $storethemesetting['footer_number'] }}">{{ $storethemesetting['footer_number'] }}</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 footer-social">
                            <ul class="nav justify-content-center justify-content-md-end mt-3 mt-md-0">
                                ...
                                @if (!empty($storethemesetting['whatsapp']))
                                    <li class="nav-item">
                                        <a class="nav-link" href="https://wa.me/{{ $storethemesetting['whatsapp'] }}"
                                            target="_blank">
                                            <i class="fab fa-whatsapp"></i>
                                        </a>
                                    </li>
