        ...
        <div class="logo-and-menu">
            <div class="company-logo">
                <a class="navbar-brand logos" href="{{ route('store.slug', $store->slug) }}">
                    ...
                    @else
                        <img style="max-width: 175px;" src="{{ asset(Storage::url('uploads/store_logo/logo.png')) }}"
                            alt="Image placeholder">
                    @endif
                </a>
            </div>
        ...
        <div class="topbar-right">
            <ul>
                ...
                @if (Utility::CustomerAuthCheck($store->slug) == true)
                    <li>
                        <a href="{{ route('store.wishlist', $store->slug) }}" class="text-uppercase">
                ...
                <li>
                    <div class="hotline-area d-xl-flex d-none">
                        <div class="icon">
                            <img src="{{ asset('assets/theme29to34/img/home1/icon/hotline-icon.svg') }}">
                        </div>
                        <div class="content">
    ...
    <header class="header-area style-6">
            ...
            <a class="navbar-brand logos" href="{{ route('store.slug', $store->slug) }}">
                @if (!empty($store->logo_dark))
                    <img style="max-width: 125px;"
                        src="{{ asset(Storage::url('uploads/store_logo/' . $store->logo_dark)) }}" alt="Image placeholder">
                @else
                    <img style="max-width: 125px;" src="{{ asset(Storage::url('uploads/store_logo/logo.png')) }}"
                        alt="Image placeholder">
                @endif
            </a>
        </div>
        ...
        <div class="nav-right d-flex jsutify-content-end align-items-center">
            ...
            @else
                ...
                <form id="customer-frm-logout" action="{{ route('customer.logout', $store->slug) }}" method="POST"
                    class="d-none">
                    {{ csrf_field() }}
                </form>
            @endif
