              ...
              <div
                      ...
                      <div class="col d-flex justify-content-lg-start">
                          <div class="footer-widget">
                              <div class="widget-title">
                                  <h5> {{ __($storethemesetting['quick_link_header_name1']) }}</h5>
                              </div>
                  ...
                  @if (isset($storethemesetting['enable_quick_link2']) && $storethemesetting['enable_quick_link2'] == 'on')
                      <div class="col d-flex justify-content-lg-start">
                          <div class="footer-widget">
                              <div class="widget-title">
                                  <h5> {{ __($storethemesetting['quick_link_header_name2']) }}</h5>
                              </div>
                              <div class="menu-container">
                                  <ul>
                  ...
                  @if (isset($storethemesetting['enable_quick_link3']) && $storethemesetting['enable_quick_link3'] == 'on')
                      <div class="col d-flex justify-content-lg-start">
                          <div class="footer-widget">
                              <div class="widget-title">
                                  <h5> {{ __($storethemesetting['quick_link_header_name3']) }}</h5>
                              </div>
                              <div class="menu-container">
                                  <ul>
                  ...
                  @if (isset($storethemesetting['enable_quick_link4']) && $storethemesetting['enable_quick_link4'] == 'on')
                      <div class="col d-flex justify-content-lg-start">
                          <div class="footer-widget">
                              <div class="widget-title">
                                  <h5> {{ __($storethemesetting['quick_link_header_name4']) }}</h5>
                              </div>
                              <div class="menu-container">
                                  <ul>
                      ...
                      <div class="footer-widget">
                          ...
                          <div class="app-download">
                              <ul>
                                  <li>
                                      <a href="#"><img
                                              src="{{ asset('assets/theme29to34/img/home1/icon/google-app.svg') }}"
                                              alt=""></a>
                                  </li>
                                  <li>
                                      <a href="#"><img
                                              src="{{ asset('assets/theme29to34/img/home1/icon/apple-app.svg') }}"
                                              alt=""></a>
                                  </li>
                              </ul>
                          </div>
                  ...
                  <a href="{{ route('store.slug', $store->slug) }}">
                      @if (
                          ...
                          <img width="300" g
                              ...
                              alt="Footer logo">
                      @else
                          <img width="300" src="{{ asset(Storage::url('uploads/store_logo/footer_logo.png')) }}"
                              alt="Footer logo">
                      @endif
                  </a>
              </div>
              <div class="contact-area">
                  ...
                  <div class="hotline-area">
                      ...
                      <div class="content">
                          ...
                          <h6><a
                                  href="mailto:{{ $storethemesetting['contact_info_email'] }}">{{ $storethemesetting['contact_info_email'] }}</a>
                          </h6>
                      </div>
                  </div>
              </div>
                  ...
                  <div class="social-area">
                      ...
                      <ul>
                          ...
                          @if (!empty($storethemesetting['email']))
                              <li>
                                  <a href="mailto:{{ $storethemesetting['email'] }}">
  ...
  <!--  Main jQuery  -->
  <script src="{{ asset('assets/theme29to34/js/jquery-3.6.0.min.js') }}"></script>
  <script src="{{ asset('assets/theme29to34/js/jquery-ui.js') }}"></script>
  <!-- Popper and Bootstrap JS -->
  <script src="{{ asset('assets/theme29to34/js/bootstrap.min.js') }}"></script>
  <script src="{{ asset('assets/theme29to34/js/popper.min.js') }}"></script>
  <!-- Swiper slider JS -->
  <script src="{{ asset('assets/theme29to34/js/swiper-bundle.min.js') }}"></script>
  <script src="{{ asset('assets/theme29to34/js/slick.js') }}"></script>
  <!-- Waypoints JS -->
  <script src="{{ asset('assets/theme29to34/js/waypoints.min.js') }}"></script>
  <!-- WOW JS -->
  <script src="{{ asset('assets/theme29to34/js/wow.min.js') }}"></script>
  <!-- Counterup JS -->
  <script src="{{ asset('assets/theme29to34/js/jquery.counterup.min.js') }}"></script>
  <!-- Isotope  JS -->
  <script src="{{ asset('assets/theme29to34/js/isotope.pkgd.min.js') }}"></script>
  <!-- Magnific-popup  JS -->
  <script src="{{ asset('assets/theme29to34/js/jquery.magnific-popup.min.js') }}"></script>
  <!-- GSAP  JS -->
  <script src="{{ asset('assets/theme29to34/js/gsap.min.js') }}"></script>
  <script src="{{ asset('assets/theme29to34/js/simpleParallax.min.js') }}"></script>
  <script src="{{ asset('assets/theme29to34/js/TweenMax.min.js') }}"></script>
  <!-- Marquee  JS -->
  <script src="{{ asset('assets/theme29to34/js/jquery.marquee.min.js') }}"></script>
  <!-- Select2  JS -->
  <script src="{{ asset('assets/theme29to34/js/jquery.nice-select.min.js') }}"></script>
  <!-- Select2  JS -->
  <script src="{{ asset('assets/theme29to34/js/jquery.fancybox.min.js') }}"></script>
  <!-- Custom JS -->
  <script src="{{ asset('assets/theme29to34/js/custom.js') }}"></script>
