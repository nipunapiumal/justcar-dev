                    ...
                    <div class="col-lg-7">
                        <div class="text-center">
                            ...
                            <div class="login-form">
                                ...
                                {!! Form::open(['route' => ['store.userstore', $slug], 'class' => 'login-form-main py-5'], ['method' => 'post']) !!}
                                ...
                                <div class="form-group">
                                    <label for="exampleInputEmail1"
                                        class="form-label float-left">{{ __('Number') }}</label>
                                ...
                                <div class="form-group">
                                    <label for="exampleInputEmail1"
                                        class="form-label float-left">{{ __('Password') }}</label>
                                ...
                                <div class="log_in_btn form-group mt-5 mb-3 d-flex align-items-center">
                                    <button type="submit"
                                        class="btn btn-primary rounded-pill hover-translate-y-n3 btn-icon mr-sm-4 scroll-me text-nowrap">{{ __('Register') }}</button>
                                    <p>{{ __('By using the system, you accept the') }} <a href=""
                                            class="text-primary"> {{ __('Privacy Policy') }} </a> and <a href=""
                                            class="text-primary"> {{ __('System Regulations') }}. </a></p>
                                </div>
                                {!! Form::close() !!}
