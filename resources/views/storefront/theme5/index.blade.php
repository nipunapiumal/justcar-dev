...
@section('content')
            ...
            <div class="row">
                <div class="col-lg-4 col-md-12">
                    <div class="banner-contain">
                        ...
                        <a href="#" class="btn btn-sm btn-primary btn-icon shadow hover-shadow-lg hover-translate-y-n3"
                            id="pro_scroll">
                            <span
                                class="btn-inner--text">{{ !empty($storethemesetting['button_text']) ? $storethemesetting['button_text'] : __('Start shopping') }}</span>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="banner-product">
                        @if (!empty($storethemesetting['header_img']) &&
                            \Storage::exists('uploads/store_logo/' . $storethemesetting['header_img']))
                            <img width="350" height="433"
                                src="{{ asset(Storage::url('uploads/store_logo/' . $storethemesetting['header_img'])) }}"
                                alt="image" />
                        @else
                            <img width="350" height="433"
                                src="{{ asset(Storage::url('uploads/store_logo/home-banner1.png')) }}" alt="image" />
                        @endif
                    </div>
                </div>
    ...
    {{-- EMAIL SUBSCRIPTION --}}
    @if (isset($storethemesetting['enable_email_subscriber']) &&
        $storethemesetting['enable_email_subscriber'] == 'on')
                                    ...
                                    <div class="card-image">
                                        <a href="{{ route('store.product.product_view', [$store->slug, $product->id]) }}">
                                            @if (!empty($topRatedProduct->product->is_cover) &&
                                                ...
                                                <img src="{{ asset(Storage::url('uploads/is_cover_image/' . $topRatedProduct->product->is_cover)) }}"
                                                    alt="Image Placeholder" class="img-center img-fluid">
                                            @else
                    ...
                    <div class="col-lg-4 col-md-12 col-sm-12">
                        <div class="mb-5">
                            <h3 class=" mt-4 store-title text-primary">
                                {{ $storethemesetting['testimonial_main_heading'] }}</h3>
                            <div class="mt-3">
                                <p class="lead lh-180 store-dcs">
                                    {{ $storethemesetting['testimonial_main_heading_title'] }}</p>
                            </div>
                        </div>
                    </div>
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        <div>
                                                            <img alt="Image placeholder"
                                                                src="{{ asset(Storage::url('uploads/store_logo/' . $storethemesetting['testimonial_img1'])) }}"
                                                        ...
                                                        <div class="pl-3">
                                                            ...
                                                            <small
                                                                class="d-block t-author-dcs">{{ $storethemesetting['testimonial_about_us1'] }}</small>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="card bg-transparent">
                                                <div class="card-body">
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        <div>
                                                            <img alt="Image placeholder"
                                                                src="{{ asset(Storage::url('uploads/store_logo/' . $storethemesetting['testimonial_img2'])) }}"
                                                                class="avatar  rounded-circle">
                                                        </div>
                                                        <div class="pl-3">
                                                            <h5 class="t-author t-black24">
                                                                {{ $storethemesetting['testimonial_name2'] }}</h5>
                                                            <small
                                                                class="d-block t-author-dcs">{{ $storethemesetting['testimonial_about_us2'] }}</small>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="card bg-transparent">
                                                <div class="card-body">
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        <div>
                                                            <img alt="Image placeholder"
                                                                src="{{ asset(Storage::url('uploads/store_logo/' . $storethemesetting['testimonial_img3'])) }}"
                                                                class="avatar  rounded-circle">
                                                        </div>
                                                        <div class="pl-3">
                                                            <h5 class="t-author t-black34">
                                                                {{ $storethemesetting['testimonial_name3'] }}</h5>
                                                            <small
                                                                class="d-block t-author-dcs">{{ $storethemesetting['testimonial_about_us3'] }}</small>
                                                        </div>
                                                    </div>
                            ...
                            <div class="col-lg-3 col-sm-6">
                                <div class="store-box">
                                    ...
                                    <div class="s-data">
                                        ...
                                        <p class=" mt-2 mb-0 t-gray">{{ $storethemesetting['features_description1'] }}
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-3 col-sm-6">
                                <div class="store-box">
                                    ...
                                    <div class="s-data">
                                        ...
                                        <p class=" mt-2 mb-0 t-gray">{{ $storethemesetting['features_description2'] }}
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-3 col-sm-6">
                                <div class="store-box">
                                    ...
                                    <div class="s-data">
                                        ...
                                        <p class=" mt-2 mb-0 t-gray">{{ $storethemesetting['features_description3'] }}
                                        </p>
                                    </div>
                                </div>
                            </div>
