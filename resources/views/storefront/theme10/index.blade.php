                                ...
                                <div class="home5_button_content d-block d-sm-flex">
                                    ...
                                    @if ($storethemesetting['enable_sidebar_panel'] == 'on')
                                        <p class="calltext ms-0 ms-sm-4 mt-3">
                                            {{ __('Contact Us') }}
                                            <br>
                                            <a class="text-thm phone_number" href="tel:{{ $storethemesetting['contact_info_phone_no'] }}">
          ...
          <div class="row">
            ...
            <div class="col-lg-6 col-xl-5">
              <div class="welcome_content_home5 bgc-thm2 wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.1s">
                <h3 class="title">{{ !empty($storethemesetting['header_title']) ? $storethemesetting['header_title'] : 'Home Accessories' }}</h3>
                <p class="para">
                    {{ !empty($storethemesetting['header_desc']) ? $storethemesetting['header_desc'] : 'Find the right price, dealer and advice.' }}
                </p>
                {{-- <a href="{{ route('store.categorie.product', [$store->slug, 'Start shopping']) }}" class="btn btn_home3_style btn-thm">{{ __('Browse Vehicles') }}</a> --}}
              </div>
            </div>
          </div>
        </div>
