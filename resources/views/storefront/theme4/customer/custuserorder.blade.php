                ...
                <div class="row">
                    <div class="col-xl-5 col-lg-6 col-md-8">
                        ...
                        <div class="two-button">
                            <a href="{{route('customer.home',$store->slug)}}" class="big-btn bg-white rounded-pill hover-translate-y-n3 mt-50 d-inline-block" id="pro_scroll">
                                <span class="nav-text">{{__('Back to order')}}</span>
