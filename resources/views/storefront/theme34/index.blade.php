                            ...
                            <div class="banner-content-bottom">
                                ...
                                {{-- <div class="rating">
                                    <a href="#">
                                        <div class="review-top">
                                            <div class="logo">
                                                <img src="{{ asset('assets/theme29to34/img/home2/icon/trustpilot-logo3.svg') }}"
                                                    alt="">
                                            </div>
                                            <div class="star">
                                                <img src="{{ asset('assets/theme29to34/img/home1/icon/trustpilot-star.svg') }}"
                        ...
                        <div class="banner-img-group">
                            <div class="top-img-group">
                                <div class="top-left-card">
                                    <div class="icon">
                                        <img src="{{ asset('assets/theme29to34/img/home6/icon/banner-icon.svg') }}"
                                            alt="">
                                    </div>
                                    <div class="content">
                                        <h4>4,56,730+</h4>
                                ...
                                <div class="top-right-img">
                                    <img src="{{ asset('assets/theme29to34/img/home6/banner-img-01.png') }}"
                                        alt="">
                                </div>
                            </div>
                            ...
                            <div class="bottom-img-group">
                                <div class="bottom-left-img">
                                    <img src="{{ asset('assets/theme29to34/img/home6/banner-img-02.png') }}"
                                        alt="">
                                </div>
                                <div class="bottom-right-img">
                                    <img src="{{ asset('assets/theme29to34/img/home6/banner-img-03.png') }}"
                                        alt="">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-12">
                        <div class="home6-filter-area d-flex align-items-center justify-content-between">
                            ...
                            <div class="explore-btn d-lg-flex d-none">
                                <a class="explore-btn2 two" href="{{ route('store.categorie.product', $store->slug) }}">{{ __('Show More') }} <i
                        ...
                        <div class="tab-content" id="myTabContent">
                            @foreach ($products as $key => $items)
                                <div class="tab-pane fade {{ $key == 'Start shopping' ? 'active show' : '' }}"
                                    id="{!! preg_replace('/[^A-Za-z0-9\-]/', '_', $key) !!}" role="tabpanel" aria-labelledby="featured-car-tab">
                                    <div class="row g-4">
                                        @if ($items->count() > 0)
                                                    ...
                                                    <div class="product-card4 style-3">
                                                        ...
                                                        <div class="product-content">
                                                            ...
                                                            <div class="button-and-price">
                                                                <a class="primary-btn7" href="{{ route('store.product.product_view', [$store->slug, $product->id]) }}">
                                                                {{__('Show More')}}    
                                                                </a>
