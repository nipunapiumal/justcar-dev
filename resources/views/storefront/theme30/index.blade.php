                                    ...
                                    @if (isset($storethemesetting['features_icon1']))
                                        <div class="col-lg-4 col-sm-12">
                                            <div class="single-work-process text-center">
                                                ...
                                                <div class="content">
                                                    <h6> {{ $storethemesetting['features_title1'] }}</h6>
                                                    <p>
                                    ...
                                    @if (isset($storethemesetting['features_icon2']))
                                        <div class="col-lg-4 col-sm-12">
                                            <div class="single-work-process text-center">
                                                ...
                                                <div class="content">
                                                    <h6> {{ $storethemesetting['features_title2'] }}</h6>
                                                    <p>
                                    ...
                                    @if (isset($storethemesetting['features_icon3']))
                                        <div class="col-lg-4 col-sm-12">
                                            <div class="single-work-process text-center">
                                                ...
                                                <div class="content">
                                                    <h6> {{ $storethemesetting['features_title3'] }}</h6>
                                                    <p>
                    ...
                    <div class="col-lg-12 d-flex justify-content-center">
                        <div class="trustpilot-review">
                            ...
                            <p>5.0 Rating out of <strong>5.0</strong> based on <a href="#"><strong>245354</strong>
                                    reviews</a></p>
                            <img src="{{ asset('assets/theme29to34/img/home1/icon/trustpilot-logo.svg') }}"
                                alt="">
                        </div>
                    </div>
                </div> --}}
