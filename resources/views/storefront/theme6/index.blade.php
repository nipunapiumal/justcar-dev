...
@section('content')
                            ...
                            <div class="banner-style-one owl-theme owl-carousel dots_none">
                                @foreach (json_decode($storethemesetting['slider_settings']) as $key => $sliderSettings)
                                    <div class="slide slide-one"
                                        style="background-image: url({{ asset(Storage::url('uploads/store_logo/' . (!empty($sliderSettings->slider_image) ? $sliderSettings->slider_image : 'home-banner.png'))) }});height: 720px;">
                                                    ...
                                                    <div class="home-content-home6-style">
                                                        {{-- <div class="home_content">
                                                            ...
                                                            <h3 class="banner_top_title text-thm">
                                                                <span class="aminated-object1"><img class="objects" src="images/home/title-bottom-border.svg" alt=""></span>
                                                                <span>$746</span> <small class="text-white">/ Month</small>
                                                            </h3>
                                                            <a href="page-car-single-v1.html" class="btn btn-thm banner-btn mt25">Learn More</a>
                                                        </div> --}}
                                                        <div class="home_content">
                                                            <h2 class="banner-title" style="line-height: 1;">
                                                                ...
                                                                <br>
                                                                <small
                                                                    class="text-thm">{{ !empty($sliderSettings->slider_description) ? $sliderSettings->slider_description : 'Find the right price, dealer and advice.' }}</small>
                                                            </h2>

                                                            {{-- <h3 class="banner_top_title text-thm">
                                                                <span class="aminated-object1"><img class="objects" src="{{ asset('assets/theme6/images/home/title-bottom-border.svg') }}" alt=""></span>
    ...
    @else
        @php
            $features_section = 'mobile_space pb100 feature_listing_home4_style  car-category bgc-f9 z-2';
            $features_section_inner = 'row justify-content-center';
        @endphp
                ...
                <div class="row posr">
                    <div class="col-lg-10 m-auto">
                        <div class="home_content home1_style">
                            <div class="home-text text-center mb30" style="margin-bottom: 40px">
                                <h2 class="title">
    ...
    @if (\App\Models\Utility::isProductPlanActive(\App\Models\User::find($store->created_by)) && $products_type1->count() > 0)
    <!-- Products Type 1 -->
    ...
    @if (isset($storethemesetting['enable_categories']) &&
        ...
        @if ($storethemesetting['enable_categories'] == 'on')
            @if ($pro_categories->count() > 1)
                {{-- otherwise slider return error when there is only one category --}}
        ...
        <section class="our-testimonials-home1 pt120 pb120">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="col-lg-12">
                            <div class="testimonial_slider_home1 wow fadeIn" data-wow-duration="1s"
                                data-wow-delay="0.1s">
