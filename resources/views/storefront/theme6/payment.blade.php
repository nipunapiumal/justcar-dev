                                        ...
                                        <div class="col-12 col-lg-4 col-md-4 text-right">
                                            ...
                                            <form class="w3-container w3-display-middle w3-card-4" method="POST"
                                                ...
                                                <div class="form-group mt-3">
                                                    <div class="text-sm-right ">
                                                        <button type="submit"
                                                            class="btn btn-thm btn-block">{{ __('Pay Now') }}</button>
                                                    </div>
                                                </div>
                                            </form>
                                        </div>
                                            ...
                                            <div class="media align-items-center">
                                                ...
                                                <div class="media-body ps-2">
                                                    <div class="sum-title lh-100">
                                                        <small
                                                            class="fw-bold mb-0">{{ $product['product_name'] . ' - ( ' . $product['variant_name'] . ' ) ' }}</small>
                                                    </div>
                                                    @php
                                                        $total_tax = 0;
                                                    @endphp
                                        ...
                                        <div class="col-8">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="media-body ps-2">
                                                    <div class="sum-title lh-100">
                                                        <small
                                                            class="fw-bold mb-0">{{ $product['product_name'] }}</small>
                                                    </div>
                                                    @php
                                                        $total_tax = 0;
                                                    @endphp
