                    ...
                    <div class="row">
                        <div class="col-xl-6 col-lg-7 d-flex align-items-center">
                            <div class="banner-content">
                                <span class="sub-title">{{ __('Contact Us') }}</span>
                                <h1>{{ __('For Any Information') }}</h1>
                                
                            </div>
                        </div>
                        <div class="col-xl-6 col-lg-5 d-lg-flex d-none align-items-center justify-content-center bg-dark d-none d-lg-flex">
                            <div class="banner-img">
                                <img src="{{ asset('assets/theme29to34/img/inner-page/inner-banner-img.png') }}"
                                    alt="">
                            </div>
                        </div>
                    </div>
            ...
            <div class="row g-4 mb-100">
                ...
                <div class="col-lg-7">
                    <div class="inquiry-form">
                        {!! Form::open(['route' => ['store.store-contact', $store->slug], 'id' => 'contact_form'], ['method' => 'POST']) !!}
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-12">
                                <div class="col-md-12">
                                    <div class="form-inner">
                                        <button type="submit" class="primary-btn3">{{ __('Get In Touch') }}</button>
                                    </div>
                                </div>
                            </div>
                        </div>
