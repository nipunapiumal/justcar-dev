    ...
    <section class="hero-banner hero-banner-3">
        <div class="container">
            <div class="row">
                            ...
                            @foreach (json_decode($storethemesetting['slider_settings']) as $key => $sliderSettings)
                                    <div class="swiper-slide">
                                        <div class="banner-content">
                                            <span class="subtitle">
                                                {{ !empty($sliderSettings->slider_description) ? $sliderSettings->slider_description : 'Find the right price, dealer and advice.' }}</span>
                ...
                <div class="col-12">
                    <div class="right-content bg-primary">
                        <div class="swiper home-img-slider" id="home-img-slider-3">
                            <div class="swiper-wrapper">
                                @foreach (json_decode($storethemesetting['slider_settings']) as $key => $sliderSettings)
                                <div class="swiper-slide">
                                    <img class="lazyload" src="{{ asset(Storage::url('uploads/store_logo/' . (!empty($sliderSettings->slider_image) ? $sliderSettings->slider_image : 'home-banner.png'))) }}"
                                        data-src="{{ asset(Storage::url('uploads/store_logo/' . (!empty($sliderSettings->slider_image) ? $sliderSettings->slider_image : 'home-banner.png'))) }}" alt="Image">
                                </div>    
                                @endforeach
                                {{-- <div class="swiper-slide">
                                    <img class="lazyload" src="assets/images/placeholder.png" data-src="assets/images/banner/hero-banner-7.jpg" alt="Image">
                                    <div class="overlay opacity-50"></div>
                                </div>
                                <div class="swiper-slide">
                                    <img class="lazyload" src="assets/images/placeholder.png" data-src="assets/images/banner/hero-banner-8.jpg" alt="Image">
                                    <div class="overlay opacity-50"></div>
                                </div>
                                <div class="swiper-slide">
                                    <img class="lazyload" src="assets/images/placeholder.png" data-src="assets/images/banner/hero-banner-9.jpg" alt="Image">
                                    <div class="overlay opacity-50"></div>
                                </div> --}}
                            </div>
                        ...
                        {{-- <a href="https://www.youtube.com/watch?v=QSwvg9Rv2EI" class="video-btn youtube-popup position-absolute top-50 start-50 translate-middle">
                    ...
                    <div class="right-content bg-primary">
                        <div class="swiper home-img-slider" id="home-img-slider-3">
                            <div class="swiper-wrapper">
                                @foreach (json_decode($storethemesetting['slider_settings']) as $key => $sliderSettings)
                                <div class="swiper-slide">
                                    <img class="lazyload" src="{{ asset(Storage::url('uploads/store_logo/' . (!empty($storethemesetting['header_img']) ? $storethemesetting['header_img'] : 'home-banner.png'))) }}"
                                        data-src="{{ asset(Storage::url('uploads/store_logo/' . (!empty($storethemesetting['header_img']) ? $storethemesetting['header_img'] : 'home-banner.png'))) }}" alt="Image">
                                </div>     
                                @endforeach
                                        ...
                                        <div class="slider-item">
                                            <div class="client mb-25">
                                                <div class="client-info d-flex align-items-center">
                                                    ...
                                                    <div class="content">
                                                        <h6 class="name">{{ $storethemesetting['testimonial_name1'] }}
                                                        </h6>
                                                        <span
                                                            class="designation">{{ $storethemesetting['testimonial_about_us1'] }}</span>
                                                    </div>
                                                </div>
                                                <div class="ratings">
                                                    <div class="rate">
                                        ...
                                        <div class="slider-item">
                                            <div class="client mb-25">
                                                <div class="client-info d-flex align-items-center">
                                                    ...
                                                    <div class="content">
                                                        <h6 class="name">{{ $storethemesetting['testimonial_name2'] }}
                                                        </h6>
                                                        <span
                                                            class="designation">{{ $storethemesetting['testimonial_about_us2'] }}</span>
                                                    </div>
                                                </div>
                                                <div class="ratings">
                                                    <div class="rate">
                                        ...
                                        <div class="slider-item">
                                            <div class="client mb-25">
                                                <div class="client-info d-flex align-items-center">
                                                    ...
                                                    <div class="content">
                                                        <h6 class="name">{{ $storethemesetting['testimonial_name3'] }}
                                                        </h6>
                                                        <span
                                                            class="designation">{{ $storethemesetting['testimonial_about_us3'] }}</span>
                                                    </div>
                                                </div>
                                                <div class="ratings">
                                                    <div class="rate">
