...
<div class="row">
    ...
    {{-- <div class="col-md-6">
        <div class="form-group">
            ...
            <div class="input-group">
                ...
                {{ Form::text('price', null, ['class' => 'form-control','id' => 'monthly_price','placeholder' => __('Enter Price'),'required' => 'required']) }}
            </div>
        </div>
    </div> --}}
    <div class="col-md-6">
    ...
    <div class="col-6">
        <div class="custom-control form-switch pt-2">
            <input type="checkbox" class="form-check-input" name="mobile_optimized" id="mobile_optimized">
            <label class="custom-control-label form-check-label"
    ...
    <div class="col-6">
        <div class="custom-control form-switch pt-2">
            <input type="checkbox" class="form-check-input" name="gallery" id="gallery">
            <label class="custom-control-label form-check-label"
    ...
    <div class="col-6">
        <div class="custom-control form-switch pt-2">
            <input type="checkbox" class="form-check-input" name="support_by_mail" id="support_by_mail">
            <label class="custom-control-label form-check-label"
                for="support_by_mail">{{ __('Email Support') }}</label>
        </div>
    </div>
    <div class="col-6">
        <div class="custom-control form-switch pt-2">
            <input type="checkbox" class="form-check-input" name="support_by_phone" id="support_by_phone">
            <label class="custom-control-label form-check-label"
    ...
    <div class="col-6">
        <div class="custom-control form-switch pt-2">
            <input type="checkbox" class="form-check-input" name="support_by_whatsapp" id="support_by_whatsapp">
            <label class="custom-control-label form-check-label"
    ...
    <div class="col-6">
        <div class="custom-control form-switch pt-2">
            <input type="checkbox" class="form-check-input" name="api_services" id="api_services">
            <label class="custom-control-label form-check-label"
