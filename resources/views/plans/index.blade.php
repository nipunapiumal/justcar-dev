        ...
        @if (
            ...
            <div class="pr-2">
                <a href="#" data-ajax-popup="true" data-size="lg" data-title="{{ __('Add Plan') }}"
                    data-url="{{ route('plans.create') }}" class="btn btn-sm btn-primary btn-icon m-1"
            ...
            <div class="plan_card">
                <div class="card price-card price-1 wow animate__fadeInUp" data-wow-delay="0.2s"
                    ...
                    <div class="card-body">
                        ...
                        @foreach ($plan->getDurations() as $duration)
                            <h4>{{ App\Models\Plan::$arrDuration[$duration->duration] }} /
                                {{ $duration->price }}{{ env('CURRENCY_SYMBOL') ? env('CURRENCY_SYMBOL') : '$' }} </h4>
                        @endforeach
                        <div class="plan-card-detail">
                            ...
                            <ul class="list-unstyled  my-4">
                                @if ($plan->free_layouts == 'on')
                                    <li>
                                        <span class="theme-avtar">
                                            <i class="text-primary fas fa-check"></i></span>{{ __('Free Layouts') }}
                                    </li>
                                @else
                                    <li class="text-danger">
                                        <span class="theme-avtar">
                                            <i class="text-danger fas fa-times-circle"></i></span>{{ __('Free Layouts') }}
                                    </li>
                                @endif
                                ...
                                @if ($plan->premium_layouts == 'on')
                                    <li>
                                        <span class="theme-avtar">
                                            <i class="text-primary fas fa-check"></i></span>{{ __('Premium Layouts') }}
                                    </li>
                                @else
                                    <li class="text-danger">
                                        <span class="theme-avtar">
                                ...
                                @if ($plan->contact_form == 'on')
                                    <li>
                                        <span class="theme-avtar">
                                            <i class="text-primary fas fa-check"></i></span>{{ __('Contact Form') }}
                                    </li>
                                @else
                                    <li class="text-danger">
                                        <span class="theme-avtar">
                                            <i class="text-danger fas fa-times-circle"></i></span>{{ __('Contact Form') }}
                                    </li>
                                @endif
                                ...
                                @else
                                    <li class="text-danger">
                                        <span class="theme-avtar">
                                            <i class="text-danger fas fa-times-circle"></i></span>{{ __('Blog') }}
                                    </li>
                                @endif
                                ...
                                @else
                                    <li class="text-danger">
                                        <span class="theme-avtar">
                                            <i class="text-danger fas fa-times-circle"></i></span>{{ __('Gallery') }}
                                    </li>
                                @endif
                                ...
                                @else
                                    <li class="text-danger">
                                        <span class="theme-avtar">
                                            <i class="text-danger fas fa-times-circle"></i></span>{{ __('Job Board') }}
                                    </li>
                                @endif
                                ...
                                @if ($plan->enable_custdomain == 'on')
                                    <li>
                                        <span class="theme-avtar">
                                            <i class="text-primary fas fa-check"></i></span>{{ __('Custom Domain') }}
                                    </li>
                                @else
                                    <li class="text-danger">
                                        <span class="theme-avtar">
                                            <i class="text-danger fas fa-times-circle"></i></span>{{ __('Custom Domain') }}
                                    </li>
                                @endif
                                ...
                                @else
                                    <li class="text-danger">
                                        <span class="theme-avtar">
                                            <i class="text-danger fas fa-times-circle"></i></span>{{ __('Unlimited') }}
                                ...
                                @if ($plan->support_by_mail == 'on')
                                    <li>
                                        <span class="theme-avtar">
                                            <i class="text-primary fas fa-check"></i></span>{{ __('Email Support') }}
                                    </li>
                                @else
                                    <li class="text-danger">
                                        <span class="theme-avtar">
                                ...
                                @if ($plan->support_by_phone == 'on')
                                    <li>
                                        <span class="theme-avtar">
                                            <i class="text-primary fas fa-check"></i></span>{{ __('Phone Support') }}
                                    </li>
                                @else
                                    <li class="text-danger">
                                        <span class="theme-avtar">
                                ...
                                @if ($plan->support_by_whatsapp == 'on')
                                    <li>
                                        <span class="theme-avtar">
                                            <i class="text-primary fas fa-check"></i></span>{{ __('Whatsapp Support') }}
                                    </li>
                                @else
                                    <li class="text-danger">
                                        <span class="theme-avtar">
                                ...
                                @if ($plan->api_services == 'on')
                                    <li>
                                        <span class="theme-avtar">
                                            <i class="text-primary fas fa-check"></i></span>{{ __('API Services') }}
                                    </li>
                                @else
                                    <li class="text-danger">
                                        <span class="theme-avtar">
                                            <i class="text-danger fas fa-times-circle"></i></span>{{ __('API Services') }}
                                    </li>
                                @endif
                                ...
                                @else
                                    <li class="text-danger">
                                        <span class="theme-avtar">
                                            <i class="text-danger fas fa-times-circle"></i></span>{{ __('Ad-Free') }}
                                    </li>
                                @endif

                                {{-- @if ($plan->premium_support == 'on')
                                    <li>
                                        <span class="theme-avtar">
                                            <i class="text-primary fas fa-check"></i></span>{{ __('Premium Support') }}
                                    </li>
                                @else
                                    <li class="text-danger">
                                        <span class="theme-avtar">
                                            <i
                                                class="text-danger fas fa-times-circle"></i></span>{{ __('Premium Support') }}
                                    </li>
                                @endif --}}
                                {{-- @if ($plan->premium_plus_support == 'on')
                                    <li>
                                        <span class="theme-avtar">
                                            <i
                                                class="text-primary fas fa-check"></i></span>{{ __('Premium Plus Support') }}
                                    </li>
                                @else
                                    <li class="text-danger">
                                        <span class="theme-avtar">
                                            <i
                                                class="text-danger fas fa-times-circle"></i></span>{{ __('Premium Plus Support') }}
                                    </li>
                                @endif --}}
                                ...
                                @elseif(\Auth::user()->plan == $plan->id)
                                    <div class="col-12">
                                        <a href="{{ route('stripe', \Illuminate\Support\Facades\Crypt::encrypt($plan->id)) }}"
                                            class="btn  btn-primary d-flex justify-content-center align-items-center ">{{ __('Change') }}
