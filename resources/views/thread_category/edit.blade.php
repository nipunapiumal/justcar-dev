...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            {{ Form::open(['url' => route('forumzone.update', $category->id), 'method' => 'post', 'enctype' => 'multipart/form-data']) }}
            <div class="row">
                <div class="col-12">
                    <div class="form-group">
                        {{ Form::label('name', __('Name'), ['class' => 'col-form-label']) }}
                        {{ Form::text('name', $category->name, ['class' => 'form-control', 'placeholder' => __('Enter Category'), 'required' => 'required']) }}
                    </div>
                </div>
