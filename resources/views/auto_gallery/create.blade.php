        ...
        $.ajax({
            ...
            success: function(data) {
                if (data.flag == "success") {
                    ...
                    window.location.href = "{{ route('auto-gallery.index') }}";
                } else {
...
{{ Form::open(['url' => 'auto-gallery', 'id' => 'frmTarget', 'method' => 'post', 'enctype' => 'multipart/form-data']) }}
<div class="row">
    <div class="col-12">
        ...
        <div class="form-group">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-12">
                        <div class="form-group">
                            {{ Form::label('sub_images', __('Upload Gallery Images'), ['class' => 'col-form-label']) }}
