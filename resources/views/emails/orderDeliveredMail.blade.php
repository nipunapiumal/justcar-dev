                                        ...
                                        <tr>
                                            <td style="width:300px;">
                                                @if($order->status == 'Cancel Order')
                                                    <img alt="" height="auto" src="{{asset('assets/img/cancel-order.png')}}" style="border:none;display:block;outline:none;text-decoration:none;height:auto;width:100%;" title="" width="300"/>
                                                @else
                                                    <img alt="" height="auto" src="{{asset('assets/img/delivery-order.png')}}" style="border:none;display:block;outline:none;text-decoration:none;height:auto;width:100%;" title="" width="300"/>
                                                @endif
                                            </td>
                                        </tr>
                                        </tbody>
