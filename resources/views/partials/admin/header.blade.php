                        ...
                        @auth('web')
                            @if (Auth::user()->type == 'Owner')
                                <a href="#" data-size="lg" data-url="{{ route('store-resource.create') }}"
                                    data-ajax-popup="true" data-title="{{ __('Create New Store') }}" class="dropdown-item">
        ...
        @if (Auth::user()->type == 'Owner')
            <li class="drp-language d-none d-sm-block">
                <a href="javascript:void(0)" onclick="startTour()"  class="dash-head-link me-0">
                    ...
                    <span class="drp-text hide-mob">{{ __('Start Tour') }}</span>
                </a>
            </li>
            <li class="drp-language">
                <a href="{{ App\Models\Utility::getStoreURL() }}"  class="dash-head-link me-0" target="_blank">
                    <i class="ti ti-arrow-up-right-circle nocolor"></i> 
                    <span class="drp-text hide-mob">{{ __('View') }} {{ __('Store') }}</span>
                </a>
            </li>
            @endif
            <li class="drp-language d-none d-sm-block">
                <a href="{{route('forum.index')}}"  class="dash-head-link me-0">
                    <i class="fas fa-user-friends nocolor"></i>
                    <span class="drp-text hide-mob">{{ __('Forum') }}</span>
                </a>
            </li>
        </ul>
