...
<script src="{{ asset('assets/js/plugins/jquery-ui-1.13.2.custom/jquery-ui.min.js') }}"></script>

<script src="{{ asset('custom/js/letter.avatar.js') }}"></script>

<script type="text/javascript" src="{{ asset('custom/js/custom.js?v=3') }}"></script>
