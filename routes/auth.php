...
Route::get('/activate/{remember_token}', [RegisteredUserController::class, 'ownerActivate'])
    ->name('store.owneractivate');
...
Route::get('/auto-login/{id}/{token}', [AuthenticatedSessionController::class, 'autoLogin'])
    ->middleware('auth')
    ->name('auto-login');
