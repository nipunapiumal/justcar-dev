...
<body>
    ...
    <?php if(!$full_page): ?>
        <!-- Top header 3 start -->
        <div class="top-header-3 d-none d-lg-block" id="top-header-3">
            <div class="container">
                            ...
                            <div class="top-header-inner">
                                ...
                                <div class="top-contact-item">
                                    ...
                                    <div class="content">
                                        ...
                                        <a
                                            href="mailto:info@fetoxe2.com"><?php echo e($storethemesetting['contact_info_email']); ?></a>
                                    </div>
                                </div>
        ...
        <!-- Main header start -->
        <header class="main-header sticky-header main-header-5" id="main-header-5">
            <div class="container">
                <div class="header-inner">
                    <nav class="navbar navbar-expand-lg navbar-light">
                        <a class="navbar-brand logos mr-auto" href="<?php echo e(route('store.slug', $store->slug)); ?>">
                            <?php if(!empty($store->logo_dark)): ?>
                                <img class="logo-photo"
                                    src="<?php echo e(asset(Storage::url('uploads/store_logo/' . $store->logo_dark))); ?>"
                                    alt="Image placeholder">
                            <?php else: ?>
                                <img class="logo-photo" src="<?php echo e(asset(Storage::url('uploads/store_logo/logo.png'))); ?>"
                                    alt="Image placeholder">
                            <?php endif; ?>
                        </a>
                        ...
                        <div class="navbar-collapse collapse w-100" id="navbar">
                            ...
                            <?php endif; ?>
                                ...
                                <?php if(Utility::CustomerAuthCheck($store->slug) != true): ?>
                                        <li class="nav-item dropdown">
                                            <a href="<?php echo e(route('customer.login', [$store->slug])); ?>" class="nav-link dropdown-toggle">
                                                <?php echo e(__('Log in')); ?>

                                            </a>
                                        </li>
                                        <li class="nav-item dropdown">
                                            <a href="<?php echo e(route('store.usercreate', [$store->slug])); ?>" class="nav-link dropdown-toggle">
                                    ...
                                    <a href="<?php echo e(route('store.cart', $store->slug)); ?>" class="nav-link h-icon">
                                        <i class="fas fa-shopping-cart fa-lg position-relative">
                                            <span
                                                ...
                                                style="font-family: sans-serif;font-size: 10px;"
                                                id="shopping_count"><?php echo e(!empty($total_item) ? $total_item : '0'); ?>22</span>
                                        </i>
                                    </a>
                                </li>
    ...
    <?php if(!$full_page): ?>
        <?php echo $__env->make('storefront.layout.theme23to28.footer-type-1', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php endif; ?>
...
<?php /**PATH /Users/nippasmac/Sites/justcar-dev/resources/views/storefront/layout/theme27.blade.php ENDPATH**/ ?>