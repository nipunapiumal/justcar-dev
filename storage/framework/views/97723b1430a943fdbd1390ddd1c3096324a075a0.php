...
<head>
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" href="<?php echo e(asset('assets/landing/img/favicon.ico')); ?>" type="image/x-icon" />
    <link rel="apple-touch-icon" href="<?php echo e(asset('assets/landing/img/apple-touch-icon.png')); ?>">

    <!-- Mobile Metas -->
    <meta name="viewport" content="width=device-width, initial-scale=1, minimum-scale=1.0, shrink-to-fit=no">

    <!-- Vendor CSS -->
    <link rel="stylesheet" href="<?php echo e(asset('assets/landing/vendor/bootstrap/css/bootstrap.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('assets/landing/vendor/fontawesome-free/css/all.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('assets/landing/vendor/animate/animate.compat.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('assets/landing/vendor/simple-line-icons/css/simple-line-icons.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('assets/landing/vendor/owl.carousel/assets/owl.carousel.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('assets/landing/vendor/owl.carousel/assets/owl.theme.default.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('assets/landing/vendor/magnific-popup/magnific-popup.min.css')); ?>">

    <!-- Theme CSS -->
    <link rel="stylesheet" href="<?php echo e(asset('assets/landing/css/theme.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('assets/landing/css/theme-elements.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('assets/landing/css/theme-blog.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('assets/landing/css/theme-shop.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('assets/landing/vendor/bootstrap-icons/bootstrap-icons.css')); ?>">
    <!-- Demo CSS -->
    <link rel="stylesheet" href="<?php echo e(asset('assets/landing/css/demos/demo-one-page-agency.css')); ?>">

    <!-- Skin CSS -->
    <link id="skinCSS" rel="stylesheet" href="<?php echo e(asset('assets/landing/css/skins/skin-one-page-agency.css')); ?>">

    <!-- Theme Custom CSS -->
    <link rel="stylesheet" href="<?php echo e(asset('assets/landing/css/custom.css')); ?>">

    <!-- Head Libs -->
    <script src="<?php echo e(asset('assets/landing/vendor/modernizr/modernizr.min.js')); ?>"></script>

</head>

<body class="<?php echo e($color); ?>" data-plugin-scroll-spy data-plugin-options="{'target': '.wrapper-spy'}">
                                ...
                                <div class="header-logo px-4">
                                    <a href="demo-one-page-agency.html">
                                        <img alt="Porto One Page Agency" width="123" height="33"
                                            src="<?php echo e(asset('assets/landing/img/demos/one-page-agency/logo.png')); ?>">
                                    </a>
                                </div>
                            </div>
                        </div>
                                            ...
                                            <ul class="nav nav-pills" id="mainNav">
                                                ...
                                                <li class="nav-item nav-item-borders py-2 pe-0 ">
                                                    <a class="nav-link" href="https://car-dealer.net/index.html"
                                                        ...
                                                        aria-expanded="false">
                                                        <img src="<?php echo e(asset('assets/landing/img/blank.gif')); ?>"
                        ...
                        <div class="owl-stage">
                            ...
                            <div class="owl-item position-relative">
                                <div class="background-image-wrapper position-absolute top-0 left-0 right-0 bottom-0 animated kenBurnsToRightTop"
                                    style="background-image: url(<?php echo e(asset('assets/landing/img/demos/one-page-agency/slides/slide-1.jpg')); ?>); background-size: cover; background-position: center; animation-duration: 20s;">
                                </div>
                                        ...
                                        <div class="col-lg-7 text-center text-sm-start mb-4 pb-5 pb-lg-0">
                                            ...
                                            <a href="#start"
                                                ...
                                                <img width="15" height="15"
                                                    src="<?php echo e(asset('assets/landing/img/demos/one-page-agency/icons/arrow-down.svg')); ?>"
                                                    alt="" data-icon
                            ...
                            <div class="owl-item position-relative">
                                <div class="background-image-wrapper position-absolute top-0 left-0 right-0 bottom-0 animated kenBurnsToRightTop"
                                    style="background-image: url(<?php echo e(asset('assets/landing/img/demos/one-page-agency/slides/slide-2.jpg')); ?>); background-size: cover; background-position: center; animation-duration: 20s;">
                                </div>
                                <div class="container position-relative z-index-3 h-100">
                                    <div class="row justify-content-start align-items-center h-100">
                                        <div class="col-lg-7 text-center text-sm-start mb-4 pb-5 pb-lg-0">
                    ...
                    <div class="row align-items-center justify-content-center justify-content-lg-between pb-5 pb-lg-0">
                        ...
                        <div class="col-9 offset-lg-1 col-lg-5 order-1 order-lg-2 scale-2">
                            <img class="img-fluid box-shadow-3 my-2 border-radius"
                                src="<?php echo e(asset('assets/landing/img/justcar-front.png')); ?>" alt="">
                        </div>
                    </div>
                </div>
            </section>
                                ...
                                <div class="portfolio-item hover-effect-1 text-center">
                                    <span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
                                        <span
                                            ...
                                            data-bg-src="<?php echo e(asset('assets/landing/img/previews/layout-1.png')); ?>">
                                            <a></a>
                                        </span>
                                    </span>
    ...
    <!-- Vendor -->
    <script src="<?php echo e(asset('assets/landing/vendor/plugins/js/plugins.min.js')); ?>"></script>

    <!-- Theme Base, Components and Settings -->
    <script src="<?php echo e(asset('assets/landing/js/theme.js')); ?>"></script>

    <!-- Current Page Vendor and Views -->
    <script src="<?php echo e(asset('assets/landing/js/views/view.contact.js')); ?>"></script>

    <!-- Demo -->
    <script src="<?php echo e(asset('assets/landing/js/demos/demo-one-page-agency.js')); ?>"></script>

    <!-- Theme Custom -->
    <script src="<?php echo e(asset('assets/landing/js/custom.js')); ?>"></script>

    <!-- Theme Initialization Files -->
    <script src="<?php echo e(asset('assets/landing/js/theme.init.js')); ?>"></script>
    ...
    <script>
        ...
        function initializeGoogleMaps() {
            ...
            var mapMarkers = [{
                ...
                icon: {
                    image: "<?php echo e(asset('assets/landing/img/pin.png')); ?>",
                    iconsize: [26, 46],
                    iconanchor: [12, 46]
                },
                popup: true
...
<?php /**PATH /Users/optimaz_id/Sites/justcar/resources/views/layouts/landing.blade.php ENDPATH**/ ?>