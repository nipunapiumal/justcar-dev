...
<div class="header-wrapper">
                        ...
                        <?php if(auth()->guard('web')->check()): ?>
                            <?php if(Auth::user()->type == 'Owner'): ?>
                                <a href="#" data-size="lg" data-url="<?php echo e(route('store-resource.create')); ?>"
                                    data-ajax-popup="true" data-title="<?php echo e(__('Create New Store')); ?>" class="dropdown-item">
    ...
    <div class="ms-auto">
        <ul class="list-unstyled">
        <?php if(Auth::user()->type == 'Owner'): ?>
            <li class="drp-language d-none d-sm-block">
                <a href="javascript:void(0)" onclick="startTour()"  class="dash-head-link me-0">
                    <i class="ti ti-player-play nocolor"></i> 
                    <span class="drp-text hide-mob"><?php echo e(__('Start Tour')); ?></span>
                </a>
            </li>
            <li class="drp-language">
                <a href="<?php echo e(App\Models\Utility::getStoreURL()); ?>"  class="dash-head-link me-0" target="_blank">
                    <i class="ti ti-arrow-up-right-circle nocolor"></i> 
                    <span class="drp-text hide-mob"><?php echo e(__('View')); ?> <?php echo e(__('Store')); ?></span>
                </a>
            </li>
            <?php endif; ?>
            <li class="drp-language d-none d-sm-block">
                <a href="<?php echo e(route('forum.index')); ?>"  class="dash-head-link me-0">
                    <i class="fas fa-user-friends nocolor"></i>
                    <span class="drp-text hide-mob"><?php echo e(__('Forum')); ?></span>
                </a>
            </li>
        </ul>
...
<?php /**PATH /Users/nippasmac/Sites/justcar-dev/resources/views/partials/admin/header.blade.php ENDPATH**/ ?>