                        ...
                        <div class="item">
                            <?php if(Utility::CustomerAuthCheck($store->slug) == false): ?>
                                <a href="<?php echo e(route('store.usercreate', [$store->slug])); ?>"
                                    class="btn btn-md btn-primary rounded-pill" title="<?php echo e(__('Register')); ?>" target="_self">
                                    <?php echo e(__('Register')); ?>

                                </a>
                            <?php else: ?>
                                <a onclick="event.preventDefault(); document.getElementById('customer-frm-logout').submit();"
                                    class="btn btn-md btn-primary rounded-pill" title="<?php echo e(__('Logout')); ?>" target="_self">
                                    <?php echo e(__('Logout')); ?>
...
<?php /**PATH /Users/nippasmac/Sites/justcar-dev/resources/views/storefront/layout/theme37.blade.php ENDPATH**/ ?>