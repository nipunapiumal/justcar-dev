                        ...
                        <div class="col-xl-8">
                            <div class="col-lg-12 mb50">
                                <div class="breadcrumb_content">
                                    <h2 class="breadcrumb_title"><?php echo e(__('Products you purchased')); ?></h2>
                                    <p><a href="<?php echo e(route('store.slug', $store->slug)); ?>"
...
<?php echo $__env->make('storefront.layout.theme6', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/optimaz_id/Sites/justcar/resources/views/storefront/theme12/customer/index.blade.php ENDPATH**/ ?>