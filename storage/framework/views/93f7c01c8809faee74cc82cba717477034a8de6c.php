        ...
        <div class="py-1">
            <?php if(\Auth::user()->type == 'Owner'): ?>
                <span class="text-muted"><?php echo e(__('Copyright')); ?> &copy;
                    <?php echo e(App\Models\Utility::getFooter(App\Models\Utility::getValByName('footer_text'))); ?>
...
<?php if(\Auth::user()->type == 'Owner'): ?>
    <script src="<?php echo e(asset('assets/js/plugins/bootstrap-tour-standalone.min.js')); ?>"></script>
    <script src="<?php echo e(asset('custom/js/tour.js')); ?>"></script>
<?php endif; ?>
...
<script src="<?php echo e(asset('assets/js/plugins/jquery-ui-1.13.2.custom/jquery-ui.min.js')); ?>"></script>

<script src="<?php echo e(asset('custom/js/letter.avatar.js')); ?>"></script>

<script type="text/javascript" src="<?php echo e(asset('custom/js/custom.js?v=3')); ?>"></script>
...
<?php /**PATH /Users/nippasmac/Sites/justcar-dev/resources/views/partials/admin/footer.blade.php ENDPATH**/ ?>