...
<body class="<?php echo e($color); ?>">
    <div class="auth-wrapper auth-v3">
        <?php if(\Request::route()->getName()!="privacy" && \Request::route()->getName()!="terms"): ?>
                ...
                <div class="container-fluid pe-2">
                    ...
                    <div class="collapse navbar-collapse" id="navbarTogglerDemo01" style="flex-grow: 0;">
                        <ul class="navbar-nav align-items-center ms-auto mb-2 mb-lg-0">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo e(route('terms',app()->getLocale())); ?>"><?php echo e(__('Term & condition')); ?></a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo e(route('privacy',app()->getLocale())); ?>"><?php echo e(__('Privacy Policy')); ?></a>
                            </li>
                        </ul>
...
<?php /**PATH /Users/optimaz_id/Sites/justcar/resources/views/layouts/auth.blade.php ENDPATH**/ ?>