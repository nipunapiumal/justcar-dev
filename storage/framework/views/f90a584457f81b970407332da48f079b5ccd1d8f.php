...
<?php $__env->startSection('content'); ?>
    ...
    <?php else: ?>
    <?php echo $__env->make('storefront.layout.theme29to34.banner-type-1', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php endif; ?>
    <!-- Slider Area End -->
                                    ...
                                    <?php if(isset($storethemesetting['features_icon1'])): ?>
                                        <div class="col-lg-4 col-sm-12">
                                            <div class="single-work-process text-center">
                                                ...
                                                <div class="content">
                                                    <h6> <?php echo e($storethemesetting['features_title1']); ?></h6>
                                                    <p>
                                    ...
                                    <?php if(isset($storethemesetting['features_icon2'])): ?>
                                        <div class="col-lg-4 col-sm-12">
                                            <div class="single-work-process text-center">
                                                ...
                                                <div class="content">
                                                    <h6> <?php echo e($storethemesetting['features_title2']); ?></h6>
                                                    <p>
                                    ...
                                    <?php if(isset($storethemesetting['features_icon3'])): ?>
                                        <div class="col-lg-4 col-sm-12">
                                            <div class="single-work-process text-center">
                                                ...
                                                <div class="content">
                                                    <h6> <?php echo e($storethemesetting['features_title3']); ?></h6>
                                                    <p>
...
<?php echo $__env->make('storefront.layout.' . $store->theme_dir . '', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/nippasmac/Sites/justcar-dev/resources/views/storefront/theme30/index.blade.php ENDPATH**/ ?>