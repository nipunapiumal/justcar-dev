    ...
    <div class="search-bar">
        ...
        <div class="filter-wrap">
            <form action="<?php echo e(route('store.categorie.product', [$store->slug, 'Start shopping'])); ?>" id="frm-filter"
                ...
                <div class="form-inner">
                    <select name="brand_id" id="brand_id" data-url="<?php echo e(route('product.get-models', [$store->slug])); ?>"
                        disabled>
                        <option value="">
                ...
                <div class="form-inner">
                    <button class="primary-btn3 w-100 justify-content-center" type="submit">
    ...
    <div class="header-and-filter-area">
        <header class="header-area style-3">
            ...
            <div class="main-menu">
                ...
                <ul class="menu-list">
                    <li>
                        <a class="drop-down" href="<?php echo e(route('store.slug', $store->slug)); ?>">
                            <?php echo e(__('Home')); ?>
            ...
            <div class="nav-right d-flex jsutify-content-end align-items-center">
                ...
                <ul>
                    ...
                    <li class="d-xl-flex d-none">
                        <a href="<?php echo e(route('store.cart', $store->slug)); ?>"
                            class="modal-btn header-cart-btn text-uppercase" type="button">
                            <i class="bi bi-bag-check"></i> <?php echo e(__('Cart')); ?> <span class="shopping_count"
                                id="shopping_count">(<?php echo e(!empty($total_item) ? $total_item : '0'); ?>)</span>
                        </a>
                    </li>
...
<?php /**PATH /Users/optimaz_id/Sites/justcar/resources/views/storefront/layout/theme31.blade.php ENDPATH**/ ?>