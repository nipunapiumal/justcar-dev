...
<body class="<?php echo e($color); ?>">
    ...
    <?php if($users->free_trial_status === 0 && \Auth::user()->type == 'Owner'): ?>
        <script>
            setTimeout(function() {

                Swal.fire({
                title: "<?php echo e(__('Welcome to')); ?> <?php echo e(env('APP_NAME')); ?>",
                text: "<?php echo e(__('We appreciate your decision to choose our services. As a token of our gratitude, we are delighted to offer you a complimentary 30-day trial of our premium account. Once the trial period concludes, you may opt to continue with the free version or upgrade to our premium version according to your preferences. We hope you enjoy the premium features and find them beneficial.')); ?>",
                preConfirm: (login) => {
                    return fetch(`<?php echo e(route('update-free-trial-msg')); ?>`)
                        .then(response => {
                            if (!response.ok) {
...
<?php /**PATH /Users/nippasmac/Sites/justcar-dev/resources/views/layouts/admin.blade.php ENDPATH**/ ?>