...
<?php $__env->startSection('action-btn'); ?>
    <div class="pr-2">
        <a href="#" data-size="lg" data-url="<?php echo e(route('blog.create')); ?>" data-ajax-popup="true"
            data-title="<?php echo e(__('Create New Vehicle Category')); ?>" class="btn btn-sm btn-primary btn-icon m-1"
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/optimaz_id/Sites/justcar/resources/views/blog/index.blade.php ENDPATH**/ ?>