    ...
    <div class="services-2 content-area">
        <div class="container">
            ...
            <div class="main-title text-center">
                <h1><?php echo e(!empty($storethemesetting['job_board_title']) ? $storethemesetting['job_board_title'] : 'Career With Us'); ?>

                </h1>
                <p><?php echo e(!empty($storethemesetting['job_board_description']) ? $storethemesetting['job_board_description'] : 'Apply Now'); ?>
...
<?php echo $__env->make('storefront.layout.theme16to21', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/nippasmac/Sites/justcar-dev/resources/views/storefront/theme16/job_board/index.blade.php ENDPATH**/ ?>