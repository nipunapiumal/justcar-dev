              ...
              <div
                      ...
                      <div class="col d-flex justify-content-lg-start">
                          <div class="footer-widget">
                              <div class="widget-title">
                                  <h5> <?php echo e(__($storethemesetting['quick_link_header_name1'])); ?></h5>
                              </div>
                  ...
                  <?php if(isset($storethemesetting['enable_quick_link2']) && $storethemesetting['enable_quick_link2'] == 'on'): ?>
                      <div class="col d-flex justify-content-lg-start">
                          <div class="footer-widget">
                              <div class="widget-title">
                                  <h5> <?php echo e(__($storethemesetting['quick_link_header_name2'])); ?></h5>
                              </div>
                              <div class="menu-container">
                                  <ul>
                  ...
                  <?php if(isset($storethemesetting['enable_quick_link3']) && $storethemesetting['enable_quick_link3'] == 'on'): ?>
                      <div class="col d-flex justify-content-lg-start">
                          <div class="footer-widget">
                              <div class="widget-title">
                                  <h5> <?php echo e(__($storethemesetting['quick_link_header_name3'])); ?></h5>
                              </div>
                              <div class="menu-container">
                                  <ul>
                  ...
                  <?php if(isset($storethemesetting['enable_quick_link4']) && $storethemesetting['enable_quick_link4'] == 'on'): ?>
                      <div class="col d-flex justify-content-lg-start">
                          <div class="footer-widget">
                              <div class="widget-title">
                                  <h5> <?php echo e(__($storethemesetting['quick_link_header_name4'])); ?></h5>
                              </div>
                              <div class="menu-container">
                                  <ul>
          ...
          <div class="footer-center">
                  ...
                  <a href="<?php echo e(route('store.slug', $store->slug)); ?>">
                      <?php if(
                          ...
                          <img width="300" g
                              ...
                              alt="Footer logo">
                      <?php else: ?>
                          <img width="300" src="<?php echo e(asset(Storage::url('uploads/store_logo/footer_logo.png'))); ?>"
                              alt="Footer logo">
                      <?php endif; ?>
                  </a>
              </div>
              <div class="contact-area">
                  ...
                  <div class="hotline-area">
                      ...
                      <div class="content">
                          <span><?php echo e(__('Email Support')); ?></span>
                          <h6><a
                                  href="mailto:<?php echo e($storethemesetting['contact_info_email']); ?>"><?php echo e($storethemesetting['contact_info_email']); ?></a>
                          </h6>
                      </div>
                  </div>
              </div>
                          ...
                          <?php if(!empty($storethemesetting['facebook'])): ?>
                              <li>
                                  <a href="<?php echo e($storethemesetting['facebook']); ?>" target="_blank">
                                      <i class="fa-xs fab fa-facebook-square"></i>
                                  </a>
                              </li>
                          <?php endif; ?>
                          <?php if(!empty($storethemesetting['twitter'])): ?>
                              <li>
                                  <a href="<?php echo e($storethemesetting['twitter']); ?>" target="_blank">
                                      <i class="fa-xs fab fa-twitter-square"></i>
                                  </a>
                              </li>
                          <?php endif; ?>
                          <?php if(!empty($storethemesetting['email'])): ?>
                              <li>
                                  <a href="mailto:<?php echo e($storethemesetting['email']); ?>">
                                      <i class="fa-xs far fa-envelope"></i>
                                  </a>
                              </li>
                          <?php endif; ?>
                          <?php if(!empty($storethemesetting['instagram'])): ?>
                              <li>
                                  <a href="<?php echo e($storethemesetting['instagram']); ?>" target="_blank">
                                      <i class="fa-xs fab fa-instagram"></i>
                                  </a>
                              </li>
                          <?php endif; ?>
                          <?php if(!empty($storethemesetting['youtube'])): ?>
                              <li>
                                  <a href="<?php echo e($storethemesetting['youtube']); ?>" target="_blank">
                                      <i class="fa-xs fab fa-youtube"></i>
                                  </a>
                              </li>
                          <?php endif; ?>
                      </ul>
  ...
  <!--  Main jQuery  -->
  <script src="<?php echo e(asset('assets/theme29to34/js/jquery-3.6.0.min.js')); ?>"></script>
  <script src="<?php echo e(asset('assets/theme29to34/js/jquery-ui.js')); ?>"></script>
  <!-- Popper and Bootstrap JS -->
  <script src="<?php echo e(asset('assets/theme29to34/js/bootstrap.min.js')); ?>"></script>
  <script src="<?php echo e(asset('assets/theme29to34/js/popper.min.js')); ?>"></script>
  <!-- Swiper slider JS -->
  <script src="<?php echo e(asset('assets/theme29to34/js/swiper-bundle.min.js')); ?>"></script>
  <script src="<?php echo e(asset('assets/theme29to34/js/slick.js')); ?>"></script>
  <!-- Waypoints JS -->
  <script src="<?php echo e(asset('assets/theme29to34/js/waypoints.min.js')); ?>"></script>
  <!-- WOW JS -->
  <script src="<?php echo e(asset('assets/theme29to34/js/wow.min.js')); ?>"></script>
  <!-- Counterup JS -->
  <script src="<?php echo e(asset('assets/theme29to34/js/jquery.counterup.min.js')); ?>"></script>
  <!-- Isotope  JS -->
  <script src="<?php echo e(asset('assets/theme29to34/js/isotope.pkgd.min.js')); ?>"></script>
  <!-- Magnific-popup  JS -->
  <script src="<?php echo e(asset('assets/theme29to34/js/jquery.magnific-popup.min.js')); ?>"></script>
  <!-- GSAP  JS -->
  <script src="<?php echo e(asset('assets/theme29to34/js/gsap.min.js')); ?>"></script>
  <script src="<?php echo e(asset('assets/theme29to34/js/simpleParallax.min.js')); ?>"></script>
  <script src="<?php echo e(asset('assets/theme29to34/js/TweenMax.min.js')); ?>"></script>
  <!-- Marquee  JS -->
  <script src="<?php echo e(asset('assets/theme29to34/js/jquery.marquee.min.js')); ?>"></script>
  <!-- Select2  JS -->
  <script src="<?php echo e(asset('assets/theme29to34/js/jquery.nice-select.min.js')); ?>"></script>
  <!-- Select2  JS -->
  <script src="<?php echo e(asset('assets/theme29to34/js/jquery.fancybox.min.js')); ?>"></script>
  <!-- Custom JS -->
  <script src="<?php echo e(asset('assets/theme29to34/js/custom.js')); ?>"></script>
...
<?php /**PATH /Users/nippasmac/Sites/justcar-dev/resources/views/storefront/layout/theme29to34/footer-type-1.blade.php ENDPATH**/ ?>