                                        ...
                                        <div class="row home-content-home2-style">
                                            <div class="col-lg-12 p0 text-center">
                                                <h2 class="banner-title" style="line-height: 1;">
                                                    ...
                                                    <br> 
                                                    <small class="text-thm"><?php echo e(!empty($storethemesetting['header_desc']) ? $storethemesetting['header_desc'] : 'Find the right price, dealer and advice.'); ?></small>
                                                </h2>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="main-title text-center text-md-start mb10-520">
                            <h2 class="title"><?php echo e(__('Vehicles')); ?></h2>
                        </div>
                    </div>
                    <div class="col-sm-6">
...
<?php echo $__env->make('storefront.layout.theme6', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/optimaz_id/Sites/justcar/resources/views/storefront/theme8/index.blade.php ENDPATH**/ ?>