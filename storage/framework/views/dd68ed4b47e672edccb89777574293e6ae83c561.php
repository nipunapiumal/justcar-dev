<?php if(Request::route()->getName() == 'vehicle_category.index'): ?>
    <?php $product_type = 2; ?>
<?php else: ?>
    <?php $product_type = 1; ?>
<?php endif; ?>
...
<?php $__env->startSection('title'); ?>
    <div class="d-inline-block">
        <h5 class="h5 d-inline-block text-white font-weight-bold mb-0 "><?php echo e(__('Category')); ?></h5>
    </div>
<?php $__env->stopSection(); ?>
...
<?php $__env->startSection('action-btn'); ?>
    <div class="pr-2">
        <a href="#" data-size="md"
            data-url="<?php echo e($product_type == 2 ? route('vehicle_category.create') : route('product_categorie.create')); ?>"
            data-ajax-popup="true" data-title="<?php echo e(__('Create New Category')); ?>"
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/optimaz_id/Sites/justcar/resources/views/product_category/index.blade.php ENDPATH**/ ?>