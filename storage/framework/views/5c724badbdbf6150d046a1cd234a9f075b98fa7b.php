                                    ...
                                    <div class="banner-content3">
                                        ...
                                        <div class="clearfix">
                                            <a href="<?php echo e(route('store.categorie.product', [$store->slug, 'Start shopping'])); ?>"
                                                class="btn-7"><?php echo e(__('Browse Vehicles')); ?></a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-5">
                                ...
                                <?php if(isset($storethemesetting['features_icon1'])): ?>
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="single-info">
                                            ...
                                            <div class="detail">
                                                <h5><a
                                                        href="services.html"><?php echo e($storethemesetting['features_title1']); ?></a>
                                                </h5>
                                ...
                                <?php if(isset($storethemesetting['features_icon2'])): ?>
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="single-info">
                                            ...
                                            <div class="detail">
                                                <h5><a
                                                        href="services.html"><?php echo e($storethemesetting['features_title2']); ?></a>
                                                </h5>
                                ...
                                <?php if(isset($storethemesetting['features_icon3'])): ?>
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="single-info">
                                            ...
                                            <div class="detail">
                                                <h5><a
                                                        href="services.html"><?php echo e($storethemesetting['features_title3']); ?></a>
                                                </h5>
...
<?php echo $__env->make('storefront.layout.theme16to21', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/optimaz_id/Sites/justcar/resources/views/storefront/theme17/index.blade.php ENDPATH**/ ?>