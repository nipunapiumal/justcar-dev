                    ...
                    <div class="carousel-content container banner-info-2 bi-2">
                        <div class="banner-content2">
                            ...
                            <a class="btn-4"
                                ...
                                <span> <?php echo e(__('Browse Vehicles')); ?></span> <i class="arrow"></i>
                            </a>
                        </div>
                    </div>
                </div>
            ...
            <div class="search-area-inner">
                <div class="search-contents">
                    <form action="<?php echo e(route('store.categorie.product', [$store->slug, 'Start shopping'])); ?>"
                        ...
                        <div class="row">
                            <div class="col-xl-3 col-lg-3 col-md-12 col-sm-12 col-12 search-col">
                                <select class="selectpicker search-fields" name="vehicle_type_id" id="vehicle_type_id2"
                                    data-url="<?php echo e(route('product.get-vehicle-brands', [$store->slug])); ?>">
                                    <option value="">
                                        <?php echo e(__('Select Vehicle Type')); ?>
                            ...
                            <div class="col-xl-3 col-lg-3 col-md-12 col-sm-12 col-12 search-col">
                                <select class="selectpicker search-fields" name="brand_id" id="brand_id2"
                                    data-url="<?php echo e(route('product.get-models', [$store->slug])); ?>" disabled>
                                    <option value="">
                                        <?php echo e(__('Select Make')); ?>
                            ...
                            <div class="col-xl-3 col-lg-3 col-md-12 col-sm-12 col-12 search-col">
                                <select class="selectpicker search-fields" name="model_id" id="model_id2" disabled>
                                    <option value="">
                                        <?php echo e(__('Select Model')); ?>
                    ...
                    <?php $__currentLoopData = $product_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="slide slide-box">
                            ...
                            <div class="car-box-4 car-photo-3"
                                style="background: url('<?php echo e(asset(Storage::url('uploads/is_cover_image/' . $product->is_cover))); ?>');background-position: center center; background-repeat: no-repeat;background-size: cover;">
                                ...
                                <div class="ling-section">
                                    ...
                                    <ul class="facilities-list clearfix">
                                        ...
                                        <li>
                                            <strong><?php echo e(__('Millage')); ?>:</strong> <?php echo e($product->millage); ?>

                                        </li>
                                        <li>
                                            <strong><?php echo e(__('Power')); ?>:</strong> <?php echo e($product->power); ?>

                                        </li>
                                        <li>
                                            <strong><?php echo e(__('Year')); ?>:</strong> <?php echo e($product->register_year); ?>

                                        </li>
                                        <li>
                                            <strong><?php echo e(__('Previous Owners')); ?>:</strong> <?php echo e($product->prev_owners); ?>
                    ...
                    <?php $__currentLoopData = $products_type1; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="col-lg-4 col-md-6">
                            <div class="car-box-3">
                                ...
                                <div class="detail">
                                    <h1 class="title"
                                        style="-webkit-line-clamp: 2;display: -webkit-box;-webkit-box-orient: vertical;height: 50px;">
                                        <a
                                            href="<?php echo e(route('store.product.product_view', [$store->slug, $product->id])); ?>"><?php echo e($product->name); ?></a>
                                    </h1>
                        ...
                        <?php if(isset($storethemesetting['features_icon1'])): ?>
                            <div class="col-lg-4 col-md-6 col-sm-12">
                                <div class="service-info-3">
                                    ...
                                    <div class="detail">
                                        <h5><a href="services.html"><?php echo e($storethemesetting['features_title1']); ?></a></h5>
                        ...
                        <?php if(isset($storethemesetting['features_icon2'])): ?>
                            <div class="col-lg-4 col-md-6 col-sm-12">
                                <div class="service-info-3">
                                    ...
                                    <div class="detail">
                                        <h5><a href="services.html"><?php echo e($storethemesetting['features_title2']); ?></a></h5>
                        ...
                        <?php if(isset($storethemesetting['features_icon3'])): ?>
                            <div class="col-lg-4 col-md-6 col-sm-12">
                                <div class="service-info-3">
                                    ...
                                    <div class="detail">
                                        <h5><a href="services.html"><?php echo e($storethemesetting['features_title3']); ?></a></h5>
...
<?php echo $__env->make('storefront.layout.theme16to21', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/optimaz_id/Sites/justcar/resources/views/storefront/theme21/index.blade.php ENDPATH**/ ?>