...
<?php $__env->startSection('content'); ?>
                ...
                <div class="row">
                                ...
                                <?php $__currentLoopData = json_decode($storethemesetting['slider_settings']); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $sliderSettings): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="swiper-slide">
                                        <div class="banner-content">
                                            <span class="subtitle">
                                                <?php echo e(!empty($sliderSettings->slider_description) ? $sliderSettings->slider_description : 'Find the right price, dealer and advice.'); ?></span>
                                            <h1 class="title mb-lg-2">
                    ...
                    <div class="col-12">
                        <div class="right-content">
                            <div class="swiper home-img-slider" id="home-img-slider-2" data-aos="fade-left">
                                <div class="swiper-wrapper">
                                    <?php $__currentLoopData = json_decode($storethemesetting['slider_settings']); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $sliderSettings): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="swiper-slide">
                                        <img class="lazyload" src="<?php echo e(asset(Storage::url('uploads/store_logo/' . (!empty($sliderSettings->slider_image) ? $sliderSettings->slider_image : 'home-banner.png')))); ?>"
                                            data-src="<?php echo e(asset(Storage::url('uploads/store_logo/' . (!empty($sliderSettings->slider_image) ? $sliderSettings->slider_image : 'home-banner.png')))); ?>" alt="Image">
                                    </div>    
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </div>
                                <!-- If we need pagination -->
                                <div class="swiper-pagination position-static mt-20 d-lg-none"
                                    id="home-img-slider-2-pagination"></div>
                            </div>
    ...
    <section class="hero-banner hero-banner-2">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <div class="swiper home-slider" data-aos="fade-up">
                        <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="banner-content">
                                        <span class="subtitle">
                ...
                <div class="col-12">
                    <div class="right-content">
                        <div class="swiper home-img-slider" id="home-img-slider-2" data-aos="fade-left">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <img class="lazyload" src="<?php echo e(asset(Storage::url('uploads/store_logo/' . (!empty($storethemesetting['header_img']) ? $storethemesetting['header_img'] : 'home-banner.png')))); ?>"
                                        data-src="<?php echo e(asset(Storage::url('uploads/store_logo/' . (!empty($storethemesetting['header_img']) ? $storethemesetting['header_img'] : 'home-banner.png')))); ?>" alt="Image">
                                </div>    
                            </div>
                            <!-- If we need pagination -->
                            <div class="swiper-pagination position-static mt-20 d-lg-none"
                                                ...
                                                <div class="col-xl-3 col-lg-4 col-md-6">
                                                    <div class="product-default border p-15 mb-25">
                                                        ...
                                                        <div class="product-details">
                                                            ...
                                                            <ul
                                                                class="product-icon-list mb-15 list-unstyled overflow-auto">
                                                                <li class="icon-start">
                                        ...
                                        <div class="slider-item">
                                            <div class="client mb-25">
                                                <div class="client-info d-flex align-items-center">
                                                    ...
                                                    <div class="content">
                                                        <h6 class="name"><?php echo e($storethemesetting['testimonial_name1']); ?>

                                                        </h6>
                                                        <span
                                                            class="designation"><?php echo e($storethemesetting['testimonial_about_us1']); ?></span>
                                                    </div>
                                                </div>
                                                <div class="ratings">
                                                    <div class="rate">
                                        ...
                                        <div class="slider-item">
                                            <div class="client mb-25">
                                                <div class="client-info d-flex align-items-center">
                                                    ...
                                                    <div class="content">
                                                        <h6 class="name"><?php echo e($storethemesetting['testimonial_name2']); ?>

                                                        </h6>
                                                        <span
                                                            class="designation"><?php echo e($storethemesetting['testimonial_about_us2']); ?></span>
                                                    </div>
                                                </div>
                                                <div class="ratings">
                                                    <div class="rate">
                                        ...
                                        <div class="slider-item">
                                            <div class="client mb-25">
                                                <div class="client-info d-flex align-items-center">
                                                    ...
                                                    <div class="content">
                                                        <h6 class="name"><?php echo e($storethemesetting['testimonial_name3']); ?>

                                                        </h6>
                                                        <span
                                                            class="designation"><?php echo e($storethemesetting['testimonial_about_us3']); ?></span>
                                                    </div>
                                                </div>
                                                <div class="ratings">
                                                    <div class="rate">
...
<?php echo $__env->make('storefront.layout.' . $store->theme_dir . '', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/nippasmac/Sites/justcar-dev/resources/views/storefront/theme36/index.blade.php ENDPATH**/ ?>