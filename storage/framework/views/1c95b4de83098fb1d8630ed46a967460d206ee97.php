                                        ...
                                        <div class="col-12 col-lg-4 col-md-4 text-right">
                                            ...
                                            <div class="form-group mt-3">
                                                <div class="text-sm-right ">
                                                    <button class="btn btn-thm btn-block" type="button"
                                        ...
                                        <div class="col-12 col-lg-4 col-md-4 text-right">
                                            ...
                                            <form class="w3-container w3-display-middle w3-card-4" method="POST"
                                                ...
                                                <div class="form-group mt-3">
                                                    <div class="text-sm-right ">
                                                        <button type="submit"
                                                            class="btn btn-thm btn-block"><?php echo e(__('Pay Now')); ?></button>
                                                    </div>
                                                </div>
                                            </form>
                                        </div>
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            if (data.is_success) {
                                ...
                                var html = '';
                                html +=
                                    '<span class="text-sm fw-bold total_price" data-value="' +
...
<?php echo $__env->make('storefront.layout.theme6', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/optimaz_id/Sites/justcar/resources/views/storefront/theme6/payment.blade.php ENDPATH**/ ?>