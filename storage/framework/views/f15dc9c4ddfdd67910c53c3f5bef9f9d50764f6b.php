...
<?php $__env->startSection('content'); ?>
    ...
    <?php if(!empty($cart['products']) || ($cart['products'] = [])): ?>
        ...
        <section class="inner_page_breadcrumb style2 bgc-f9 bt1 inner_page_section_spacing cart-section mt-100">
            <div class="container">
                <!-- Main title -->
                <div class="one mb-50">
                    <h1 class="heading-1"> <?php echo e(__('My Cart')); ?></h1>
                </div>
        </section>

<!-- Shop Checkouts Content -->
<section class="shop-cart bgc-f9 pt0 mb-50">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class="row">
                                                        ...
                                                        <td class="pr25">
                                                            <a href="javascript:void(0)" data-bs-toggle="tooltip"
                                                                ...
                                                                data-bs-original-title="<?php echo e(__('Move to trash')); ?>"><span
                                                                    class="bi bi-trash3-fill"></span></a>
                                                            <?php echo Form::open([
                                                                'method' => 'DELETE',
                                                                'route' => ['delete.cart_item', [$store->slug, $product['product_id'], $product['variant_id']]],
                                                                'id' => 'delete-product-cart-' . $key,
...
<?php echo $__env->make('storefront.layout.theme30', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/nippasmac/Sites/justcar-dev/resources/views/storefront/theme30/cart.blade.php ENDPATH**/ ?>