...
<?php $__env->startSection('content'); ?>
                            ...
                            <div class="banner-style-one owl-theme owl-carousel dots_none">
                                <?php $__currentLoopData = json_decode($storethemesetting['slider_settings']); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $sliderSettings): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="slide slide-one"
                                        style="background-image: url(<?php echo e(asset(Storage::url('uploads/store_logo/' . (!empty($sliderSettings->slider_image) ? $sliderSettings->slider_image : 'home-banner.png')))); ?>);height: 720px;">
                                                    ...
                                                    <div class="home-content-home6-style">
                                                        ...
                                                        <div class="home_content">
                                                            <h2 class="banner-title" style="line-height: 1;">
                                                                ...
                                                                <br>
                                                                <small
                                                                    class="text-thm"><?php echo e(!empty($sliderSettings->slider_description) ? $sliderSettings->slider_description : 'Find the right price, dealer and advice.'); ?></small>
                                                            </h2>
    ...
    <?php if(isset($storethemesetting['enable_features']) && $storethemesetting['enable_features'] == 'on'): ?>
        <section class="<?php echo e($features_section); ?>">
            <div class="container">
                <?php if(isset($storethemesetting['enable_slider_settings']) && $storethemesetting['enable_slider_settings'] == 'on'): ?>
                    <div class="row mb20">
                        <div class="col-lg-10 m-auto">
                ...
                <?php endif; ?>
                <div class="<?php echo e($features_section_inner); ?>">
                    <div class="col-lg-8">
    ...
    <?php if(\App\Models\Utility::isProductPlanActive(\App\Models\User::find($store->created_by)) && $products_type1->count() > 0): ?>
    <!-- Products Type 1 -->
...
<?php echo $__env->make('storefront.layout.theme6_', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/nippasmac/Sites/justcar-dev/resources/views/storefront/theme6/index.blade.php ENDPATH**/ ?>