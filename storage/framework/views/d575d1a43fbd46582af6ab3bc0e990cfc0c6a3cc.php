            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        ...
                        datType: 'json',
                        data: {
                            product_plan_id: '<?php echo e(\Illuminate\Support\Facades\Crypt::encrypt($product_plan->id)); ?>',
                            coupon: coupon
                        },
                ...
                var handler = PaystackPop.setup({
                    ...
                    callback: function(response) {
                        ...
                        window.location.href = paystack_callback + '/' + response.reference + '/' +
                            '<?php echo e(\Illuminate\Support\Facades\Crypt::encrypt($product_plan->id)); ?>?coupon_id=' +
                            coupon_id;
                    },
                    onClose: function() {
                        alert('window closed');
        ...
        <?php if(isset($admin_payments_details['is_mercado_enabled']) && $admin_payments_details['is_mercado_enabled'] == 'on'): ?>
            ...
            function payMercado(amount) {
                ...
                var data = {
                    coupon_id: coupon_id,
                    total_price: amount,
                    plan: <?php echo e($product_plan->id); ?>,
                }
                console.log(data);
                $.ajax({
                            ...
                            <div class="card price-card price-1 wow animate__fadeInUp" data-wow-delay="0.2s"
                                ...
                                <div class="card-body">
                                    <span class="price-badge bg-primary">
                                        <?php echo e($product_plan->name); ?>

                                    </span>
                                    <?php if(\Auth::user()->type == 'Owner' && \Auth::user()->plan == $product_plan->id): ?>
                                        ...
                                        <div class="mb-3">
                                            <?php if(\Auth::user()->type == 'super admin'): ?>
                                                <div class="action-btn bg-primary ms-2">
                                                    <a href="#"
                                                        data-url="<?php echo e(route('product-plan.edit', $product_plan->id)); ?>"
                                    ...
                                    <ul class="list-unstyled  my-4">
                                        <?php if($product_plan->price): ?>
                                            <li>
                                                <span class="theme-avtar">
                                                    <i
                                                        class="text-primary fas fa-check"></i></span><?php echo e(__('Enable Products')); ?>
                                        ...
                                        <?php else: ?>
                                            <li class="text-danger">
                                                <span class="theme-avtar">
                                                    <i
                                                        class="text-danger fas fa-times-circle"></i></span><?php echo e(__('Enable Products')); ?>
                                    ...
                                    <?php
                                        $priceWithTax = App\Models\CopyrightPlan::priceWithTax($product_plan->price);
                                    ?>
                        ...
                        <div id="stripe_payment" class="card">
                            ...
                            <?php if(
                                ...
                                <div class="tab-pane <?php echo e(($admin_payments_details['is_stripe_enabled'] == 'on' && !empty($admin_payments_details['stripe_key']) && !empty($admin_payments_details['stripe_secret'])) == 'on' ? 'active' : ''); ?>"
                                    id="stripe_payment">
                                    <form role="form" action="<?php echo e(route('stripe.payv4')); ?>" method="post"
                                        ...
                                        <div class="col-sm-12 my-2 px-2">
                                            <div class="text-end">
                                                ...
                                                <input type="hidden" name="product_plan_id"
                                                    value="<?php echo e(\Illuminate\Support\Facades\Crypt::encrypt($product_plan->id)); ?>">
                            ...
                            <?php if(
                                ...
                                <div class="tab-pane <?php echo e(($admin_payments_details['is_stripe_enabled'] != 'on' && $admin_payments_details['is_paypal_enabled'] == 'on' && !empty($admin_payments_details['paypal_client_id']) && !empty($admin_payments_details['paypal_secret_key'])) == 'on' ? 'active' : ''); ?>"
                                    ...
                                    <form class="w3-container w3-display-middle w3-card-4" method="POST"
                                        id="payment-form" action="<?php echo e(route('product.plan.pay.with.paypal')); ?>">
                                        <?php echo csrf_field(); ?>
                                ...
                                <div class="tab-pane " id="paytm_payment">
                                    <form class="w3-container w3-display-middle w3-card-4" method="POST"
                                        ...
                                        <input type="hidden" name="total_price" id="paytm_total_price"
                                            value="<?php echo e($product_plan->price); ?>" class="form-control">
                                        <div class="border p-3 mb-3 rounded payment-box">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/optimaz_id/Sites/justcar/resources/views/product_plans/stripe.blade.php ENDPATH**/ ?>