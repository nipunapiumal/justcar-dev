...
<?php $__env->startSection('content'); ?>
    ...
    <!-- Photo gallery start -->
        <!-- Photo gallery start -->
        <div class="blog-body pb-100 inner-title">
            <div class="container">
                <!-- Main title -->
                <div class="one mb-50">
...
<?php echo $__env->make('storefront.layout.theme32', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/nippasmac/Sites/justcar-dev/resources/views/storefront/theme32/gallery/index.blade.php ENDPATH**/ ?>