    ...
    <div class="wrapper ovh">
            ...
            <nav>
                <div class="container">
                    ...
                    <ul id="respMenu" class="ace-responsive-menu menu_list_custom_code wa float-start"
                        ...
                        <li> <a href="<?php echo e(route('store.slug', $store->slug)); ?>"><span
                                    class="title"><?php echo e(__('Home')); ?></span></a></li>
                    ...
                    <ul id="respMenu2" class="ace-responsive-menu menu_list_custom_code wa text-end"
                        ...
                        <?php if(Utility::CustomerAuthCheck($store->slug) != true): ?>
                            ...
                            <li><a href="#">|</a></li>
                            <li><a href="<?php echo e(route('store.usercreate', $store->slug)); ?>"><?php echo e(__('Register')); ?></a></li>
                        <?php else: ?>
                            <li>
                                <a href="#"
                                    onclick="event.preventDefault(); document.getElementById('customer-frm-logout').submit();">
        ...
        <div id="page" class="stylehome1 h0">
            ...
            <nav id="menu" class="stylehome1">
                <ul>
                    <li>
                        <a href="<?php echo e(route('store.slug', $store->slug)); ?>"><span
                                class="title"><?php echo e(__('Home')); ?></span>
                        </a>
                    </li>
                    <?php if($storethemesetting['primary_nav_menu']): ?>
                        <?php $__currentLoopData = json_decode($storethemesetting['primary_nav_menu']); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menu_title): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <!-- Our Footer -->
        <section class="footer_one home4_style pt50 pb25">
            <div class="container">
                <div class="row">
...
<?php /**PATH /Users/optimaz_id/Sites/justcar/resources/views/storefront/layout/theme9.blade.php ENDPATH**/ ?>