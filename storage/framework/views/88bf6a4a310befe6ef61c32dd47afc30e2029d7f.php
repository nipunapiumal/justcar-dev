...
<?php $__env->startSection('content'); ?>
    <div class="row">
        ...
        <div class="col-xl-4">
            <?php if(\Auth::user()): ?>
            <a href="<?php echo e(route('forum.create')); ?>" class="btn btn-primary w-100 mb-4"><?php echo e(__('Post Thread')); ?></a>
            <?php endif; ?>
            <div class="card">
...
<?php echo $__env->make('layouts.forum', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/optimaz_id/Sites/justcar/resources/views/forum/create-category.blade.php ENDPATH**/ ?>