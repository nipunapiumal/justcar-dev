...
<body>
    ...
    <?php if(!$full_page): ?>
        <!-- Main header start -->
        <header class="main-header header-fixed sticky-header" id="main-header-7">
            <div class="container">
                <div class="header-inner">
                    <nav class="navbar navbar-expand-lg navbar-light">
                        <a class="navbar-brand logos d-flex w-33 mr-auto"
                        ...
                        <div class="navbar-collapse collapse w-100 justify-content-end" id="navbar">
                            ...
                            <?php endif; ?>
                                ...
                                <?php if(Utility::CustomerAuthCheck($store->slug) != true): ?>
                                    ...
                                    <li class="nav-item dropdown">
                                        <a href="<?php echo e(route('store.usercreate', [$store->slug])); ?>" class="nav-link">
...
<?php /**PATH /Users/nippasmac/Sites/justcar-dev/resources/views/storefront/layout/theme26.blade.php ENDPATH**/ ?>