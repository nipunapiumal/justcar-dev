...
<?php $__env->startSection('content'); ?>
    ...
    <div class="contact-page inner-title-33">
        <div class="container">
            <div class="one mb-50">
                <h1 class="heading-1"><?php echo e(__('Contact Us')); ?></h1>
            </div>
            <div class="row g-4 mb-100">
                <div class="col-lg-5">
                    <div class="single-contact mb-40">
                        <div class="title">
                            <h6><?php echo e(__('Phone Support')); ?></h6>
                        </div>
                        <div class="icon">
                    ...
                    <div class="single-contact mb-40">
                        <div class="title">
                            <h6><?php echo e(__('Email Support')); ?></h6>
                        </div>
                        <div class="icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20">
                                <path
                ...
                <div class="col-lg-7">
                    <div class="inquiry-form">
                        <?php echo Form::open(['route' => ['store.store-contact', $store->slug], 'id' => 'contact_form'], ['method' => 'POST']); ?>
                            ...
                            <div class="col-md-12">
                                <div class="col-md-12">
                                    <div class="form-inner">
                                        <button type="submit" class="primary-btn3"><?php echo e(__('Get In Touch')); ?></button>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<?php echo $__env->make('storefront.layout.theme33', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/nippasmac/Sites/justcar-dev/resources/views/storefront/theme33/contact/index.blade.php ENDPATH**/ ?>