...
<?php $__env->startPush('css-page'); ?>
    <style>
        .bg-home5,.half-bg-img-divider:before {
...
<?php $__env->startSection('content'); ?>
    ...
    <?php if(isset($storethemesetting['enable_slider_settings']) && $storethemesetting['enable_slider_settings'] == 'on'): ?>
        <section class="home-one home5_style p0 mt70-992">
                                            ...
                                            <div class="row home-content pt130">
                                                <div class="col-xl-8 offset-xl-2">
                                                    <div class="sliding-box-object">
                                                        <div class="home-text">
                                                            <h1 class="title display-4"><span class="aminated-object1"><img
                                                                        class="objects"
    ...
    <?php else: ?>
        <section class="home-one home5_style bg-home5 p0 mt70-992">
            <div class="container">
                <div class="row posr">
                    <div class="col-lg-7">
                        <div class="home_content_home5_style">
                            <div class="wrapper mb30 mb0-sm ">
                                <h2 class="title">
                                ...
                                <div class="home5_button_content d-block d-sm-flex">
                                    <a class="btn btn-thm me-0 me-sm-1"
                                        href="<?php echo e(route('store.categorie.product', [$store->slug, 'Start shopping'])); ?>"><?php echo e(__('Browse Vehicles')); ?></a>

                                    <?php if($storethemesetting['enable_sidebar_panel'] == 'on'): ?>
                                        <p class="calltext ms-0 ms-sm-4 mt-3">
                                            <?php echo e(__('Contact Us')); ?>

                                            <br>
                                            <a class="text-thm phone_number" href="tel:<?php echo e($storethemesetting['contact_info_phone_no']); ?>">
    ...
    <?php if(isset($storethemesetting['enable_brand_logo']) && $storethemesetting['enable_brand_logo'] == 'on'): ?>
        <section class="our-partner pb100 pt30">
            <div class="container">
                                            ...
                                            <?php if($items->count() > 0): ?>
                                                <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    ...
                                                    <div class="col-sm-6 col-xl-3">
                                                        <div class="car-listing p0 bdr_none">
                                                            <div class="thumb">
    ...
    <section class="half-bg-img-divider">
        <div class="container">
          <div class="row">
            <div class="col-lg-6 col-xl-7"></div>
            <div class="col-lg-6 col-xl-5">
              <div class="welcome_content_home5 bgc-thm2 wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.1s">
                <h3 class="title"><?php echo e(!empty($storethemesetting['header_title']) ? $storethemesetting['header_title'] : 'Home Accessories'); ?></h3>
                <p class="para">
                    <?php echo e(!empty($storethemesetting['header_desc']) ? $storethemesetting['header_desc'] : 'Find the right price, dealer and advice.'); ?>

                </p>
                <a href="<?php echo e(route('store.categorie.product', [$store->slug, 'Start shopping'])); ?>" class="btn btn_home3_style btn-thm"><?php echo e(__('Browse Vehicles')); ?></a>
              </div>
            </div>
          </div>
        </div>
    ...
    <?php if(isset($storethemesetting['enable_features']) && $storethemesetting['enable_features'] == 'on'): ?>
        <section class="we-are-best pt-2 ">
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 m-auto">
                        <div class="main-title text-center">
                ...
                <div class="row">
                    <?php if(isset($storethemesetting['enable_features1']) && $storethemesetting['enable_features1'] == 'on'): ?>
                        <?php if(isset($storethemesetting['features_icon1'])): ?>
                            <div class="col-sm-12 col-xl-4 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.1s">
...
<?php echo $__env->make('storefront.layout.theme6', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/optimaz_id/Sites/justcar/resources/views/storefront/theme10/index.blade.php ENDPATH**/ ?>