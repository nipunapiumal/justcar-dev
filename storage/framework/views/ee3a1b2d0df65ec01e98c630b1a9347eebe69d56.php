                ...
                var options = {
                    ...
                    "handler": function(response) {
                        window.location.href = razorPay_callback + '/' + response.razorpay_payment_id + '/' +
                            '<?php echo e(\Illuminate\Support\Facades\Crypt::encrypt($plan->id)); ?>?coupon_id=' + coupon_id;
                    },
                    "theme": {
                        "color": "#528FF0"
                    }
        ...
        $(document).ready(function() {
            $(document).on('click', '.apply-coupon', function() {
                ...
                $.ajax({
                    ...
                    data: {
                        plan_id: '<?php echo e(\Illuminate\Support\Facades\Crypt::encrypt($plan->id)); ?>',
                        plan_duration_id: '<?php echo e(\Illuminate\Support\Facades\Crypt::encrypt($defaultDuration)); ?>',
                        coupon: coupon
                    },
                    success: function(data) {
                            ...
                            <div class="card price-card price-1 wow animate__fadeInUp" data-wow-delay="0.2s"
                                ...
                                <div class="card-body">
                                        ...
                                        <div class="">
                                            <?php if(\Auth::user()->type == 'super admin'): ?>
                                                <a title="Edit Plan" data-size="lg" href="#" class="action-item"
                                                    ...
                                                    data-bs-placement="top" title="<?php echo e(__('Edit Plan')); ?>"><i
                                    ...
                                    <h3 class="mb-4 f-w-600 plan-dynamic-info">
                                        <?php echo e(env('CURRENCY_SYMBOL') ? env('CURRENCY_SYMBOL') : '$'); ?><?php echo e($plan->price . ' / ' . $plan->duration); ?>
                                    ...
                                    <div class="row mt-5">
                                        <div class="form-group">
                                            <?php $i=1; ?>
                                            <?php $__currentLoopData = $planDurations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $planDuration): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php
                                                    
                                                ?>
                                                <div class="form-check form-check-inline mb-3">
                                                    <input type="radio" id="customRadio<?php echo e($i); ?>"
                                                        name="plan_duration"
                                                        value="<?php echo e(\Illuminate\Support\Facades\Crypt::encrypt($planDuration->id)); ?>"
                                                        class="form-check-input plan_duration"
                                                        data-price="<?php echo e($planDuration->price); ?><?php echo e(env('CURRENCY_SYMBOL') ? env('CURRENCY_SYMBOL') : '$'); ?>"
                                                        data-duration="<?php echo e(App\Models\Plan::$arrDuration[$planDuration->duration]); ?>"
                                                        <?php echo e($planDuration->id == $defaultDuration ? 'checked' : ''); ?>>
                                                    <label class="form-check-label"
                                                        for="customRadio<?php echo e($i); ?>"><?php echo e(App\Models\Plan::$arrDuration[$planDuration->duration]); ?>

                                                        /
                                                        <?php echo e($planDuration->price); ?><?php echo e(env('CURRENCY_SYMBOL') ? env('CURRENCY_SYMBOL') : '$'); ?></label>
                                                </div>
                                                <?php $i++; ?>
                                    ...
                                    <ul class="list-unstyled  my-5">
                                        <?php if($plan->free_layouts == 'on'): ?>
                                            <li>
                                                <span class="theme-avtar">
                                                    <i
                                                        class="text-primary fas fa-check"></i></span><?php echo e(__('Free Layouts')); ?>
                                        ...
                                        <?php else: ?>
                                            <li class="text-danger">
                                                <span class="theme-avtar">
                                                    <i
                                                        class="text-danger fas fa-times-circle"></i></span><?php echo e(__('Free Layouts')); ?>
                                        ...
                                        <?php if($plan->premium_layouts == 'on'): ?>
                                            <li>
                                                <span class="theme-avtar">
                                                    <i
                                                        class="text-primary fas fa-check"></i></span><?php echo e(__('Premium Layouts')); ?>
                                        ...
                                        <?php if($plan->contact_form == 'on'): ?>
                                            <li>
                                                <span class="theme-avtar">
                                                    <i
                                                        class="text-primary fas fa-check"></i></span><?php echo e(__('Contact Form')); ?>
                                        ...
                                        <?php else: ?>
                                            <li class="text-danger">
                                                <span class="theme-avtar">
                                                    <i
                                                        class="text-danger fas fa-times-circle"></i></span><?php echo e(__('Contact Form')); ?>
                                        ...
                                        <?php else: ?>
                                            <li class="text-danger">
                                                <span class="theme-avtar">
                                                    <i
                                                        class="text-danger fas fa-times-circle"></i></span><?php echo e(__('Blog')); ?>
                                        ...
                                        <?php else: ?>
                                            <li class="text-danger">
                                                <span class="theme-avtar">
                                                    <i
                                                        class="text-danger fas fa-times-circle"></i></span><?php echo e(__('Gallery')); ?>
                                        ...
                                        <?php else: ?>
                                            <li class="text-danger">
                                                <span class="theme-avtar">
                                                    <i
                                                        class="text-danger fas fa-times-circle"></i></span><?php echo e(__('Job Board')); ?>
                                        ...
                                        <?php if($plan->enable_custdomain == 'on'): ?>
                                            <li>
                                                <span class="theme-avtar">
                                                    <i
                                                        class="text-primary fas fa-check"></i></span><?php echo e(__('Custom Domain')); ?>
                                        ...
                                        <?php else: ?>
                                            <li class="text-danger">
                                                <span class="theme-avtar">
                                                    <i
                                                        class="text-danger fas fa-times-circle"></i></span><?php echo e(__('Custom Domain')); ?>
                                        ...
                                        <?php else: ?>
                                            <li class="text-danger">
                                                <span class="theme-avtar">
                                                    <i
                                                        class="text-danger fas fa-times-circle"></i></span><?php echo e(__('Unlimited')); ?>
                                        ...
                                        <?php if($plan->support_by_mail == 'on'): ?>
                                            <li>
                                                <span class="theme-avtar">
                                                    <i
                                                        class="text-primary fas fa-check"></i></span><?php echo e(__('Email Support')); ?>
                                        ...
                                        <?php if($plan->support_by_phone == 'on'): ?>
                                            <li>
                                                <span class="theme-avtar">
                                                    <i
                                                        class="text-primary fas fa-check"></i></span><?php echo e(__('Phone Support')); ?>
                                        ...
                                        <?php if($plan->support_by_whatsapp == 'on'): ?>
                                            <li>
                                                <span class="theme-avtar">
                                                    <i
                                                        class="text-primary fas fa-check"></i></span><?php echo e(__('Whatsapp Support')); ?>
                                        ...
                                        <?php if($plan->api_services == 'on'): ?>
                                            <li>
                                                <span class="theme-avtar">
                                                    <i
                                                        class="text-primary fas fa-check"></i></span><?php echo e(__('API Services')); ?>
                                        ...
                                        <?php else: ?>
                                            <li class="text-danger">
                                                <span class="theme-avtar">
                                                    <i
                                                        class="text-danger fas fa-times-circle"></i></span><?php echo e(__('API Services')); ?>
                                        ...
                                        <?php else: ?>
                                            <li class="text-danger">
                                                <span class="theme-avtar">
                                                    <i
                                                        class="text-danger fas fa-times-circle"></i></span><?php echo e(__('Ad-Free')); ?>
                        ...
                        <div id="stripe_payment" class="card">
                            ...
                            <?php if(
                                ...
                                <div class="tab-pane <?php echo e(($admin_payments_details['is_stripe_enabled'] == 'on' && !empty($admin_payments_details['stripe_key']) && !empty($admin_payments_details['stripe_secret'])) == 'on' ? 'active' : ''); ?>"
                                    id="stripe_payment">
                                    <form role="form" action="<?php echo e(route('stripe.payment')); ?>" method="post"
                                        ...
                                        <div class="col-sm-12 my-2 px-2">
                                            <div class="text-end">
                                                <input type="hidden"
                                                    value="<?php echo e(\Illuminate\Support\Facades\Crypt::encrypt($defaultDuration)); ?>"
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/optimaz_id/Sites/justcar/resources/views/plans/stripe.blade.php ENDPATH**/ ?>