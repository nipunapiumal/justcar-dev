            ...
            <div class="row">
                <div class="col-12">
                    <div class="section-title title-center mb-50" data-aos="fade-up">
                        <span class="subtitle mb-10"><?php echo e(__('Features')); ?></span>
                        <h2 class="title">
                            <?php echo e(__('Why Choose Us?')); ?>
                                    ...
                                    <div class="card align-items-center text-center radius-md p-25 mb-30">
                                        ...
                                        <div class="card-content">
                                            <h4 class="card-title mb-20">
                                                <?php echo e($storethemesetting['features_title1']); ?>
...
<?php endif; ?>
<?php /**PATH /Users/nippasmac/Sites/justcar-dev/resources/views/storefront/layout/theme35to37/features-type-1.blade.php ENDPATH**/ ?>