            ...
            <?php $__currentLoopData = json_decode($storethemesetting['sortable_nav_menu']); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menu_title): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <?php if(is_numeric($menu_title) && floor($menu_title) == $menu_title): ?>
                    ...
                    <?php if(isset($page_slug_url->slug)): ?>
                        <li>
                            <a class="drop-down" href="<?php echo e(env('APP_URL') . '/page/' . $page_slug_url->slug); ?>">
                ...
                <?php else: ?>
                    <?php if($menu_title == 'Blog' && $store['blog_enable'] == 'on' && !empty($blog)): ?>
                        <li>
                            <a class="drop-down" href="<?php echo e(route('store.blog', $store->slug)); ?>">
                    ...
                    <?php elseif($menu_title == 'Contact Us'): ?>
                        <li>
                            <a class="drop-down" href="<?php echo e(route('store.contact', $store->slug)); ?>">
                                <?php echo e(__($menu_title)); ?>
                    ...
                    <?php elseif(
                        ...
                        <li>
                            <a class="drop-down" href="<?php echo e(route('store.gallery', [$store->slug])); ?>">
                                <?php echo e(__($menu_title)); ?>
                    ...
                    <?php elseif(
                        ...
                        <li>
                            <a class="drop-down" href="<?php echo e(route('store.job-board', [$store->slug])); ?>">
                                <?php echo e(__($menu_title)); ?>
...
<?php /**PATH /Users/optimaz_id/Sites/justcar/resources/views/storefront/layout/theme32.blade.php ENDPATH**/ ?>