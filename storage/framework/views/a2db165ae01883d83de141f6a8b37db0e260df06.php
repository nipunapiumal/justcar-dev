...
<?php $__env->startSection('breadcrumb'); ?>
    ...
    <li class="breadcrumb-item active" aria-current="page"><?php echo e(__('Copyright Plans')); ?></li>
<?php $__env->stopSection(); ?>
<?php $__env->startSection('title'); ?>
    <div class="d-inline-block">
        <h5 class="h4 d-inline-block text-white font-weight-bold mb-0 "><?php echo e(__('Copyright Plans')); ?></h5>
    </div>
<?php $__env->stopSection(); ?>
        ...
        <?php if(
            ...
            <div class="pr-2">
                <a href="#" data-ajax-popup="true" data-size="lg" data-title="<?php echo e(__('Add Plan')); ?>"
                    data-url="<?php echo e(route('copyright-plan.create')); ?>" class="btn btn-sm btn-primary btn-icon m-1"
...
<?php $__env->startSection('content'); ?>
    <div class="row">
        <?php $__currentLoopData = $copyright_plans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $copyright_plan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="plan_card">
                <div class="card price-card price-1 wow animate__fadeInUp" data-wow-delay="0.2s"
                    style="
                                  ...
                                  ">
                    <div class="card-body">
                        <span class="price-badge bg-primary"><?php echo e($copyright_plan->name); ?></span>
                        <?php if(\Auth::user()->type == 'Owner' && \Auth::user()->copyright_plan == $copyright_plan->id): ?>
                            ...
                            <div class="mb-3">
                                <?php if(\Auth::user()->type == 'super admin'): ?>
                                    <div class="action-btn bg-primary ms-2">
                                        <a href="#"
                                            data-url="<?php echo e(route('copyright-plan.edit', $copyright_plan->id)); ?>"
                        ...
                        <h4 class="f-w-600">
                            ...
                            <?php echo e($copyright_plan->price); ?><?php echo e(env('CURRENCY_SYMBOL')); ?>

                        </h4>
                        <h6 class="f-w-600">
                            <?php if($copyright_plan->price == 0): ?>
                            ...
                            <?php if($copyright_plan->price): ?>
                                <li>
                                    <span class="theme-avtar">
                                        <i class="text-primary fas fa-check"></i></span><?php echo e(__('Customize Footer')); ?>

                                </li>
                            <?php else: ?>
                                <li class="text-danger">
                                    <span class="theme-avtar">
                                        <i class="text-danger fas fa-times-circle"></i></span><?php echo e(__('Customize Footer')); ?>
                        ...
                        <div class="storage-plan-card-detail">
                            <?php if($copyright_plan->description): ?>
                                <p class="mb-0">
                                    <?php echo e($copyright_plan->description); ?><br />
                                </p>
                            <?php endif; ?>
                        </div>
                        ...
                        <div class="row">
                            <?php if(\Auth::user()->type != 'super admin'): ?>
                                <?php if(\Auth::user()->copyright_plan == $copyright_plan->id && date('Y-m-d') < \Auth::user()->copyright_plan_expire_date): ?>
                                    <h5 class="h6 my-4">
                                        <?php echo e(__('Expired : ')); ?>

                                        <?php echo e(\Auth::user()->copyright_plan_expire_date ? \App\Models\Utility::dateFormat(\Auth::user()->copyright_plan_expire_date) : __('Unlimited')); ?>
                                ...
                                <?php elseif(\Auth::user()->copyright_plan == $copyright_plan->id): ?>
                                    <div class="col-12">
                                ...
                                <?php else: ?>
                                    <div class="col-12">
                                        <a href="<?php echo e(route('stripe', ['code' => \Illuminate\Support\Facades\Crypt::encrypt($copyright_plan->id), 'type' => 'copyright'])); ?>"
                            ...
                            <tbody>
                                <?php $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td><?php echo e($order->copyright_plan_name); ?></td>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/optimaz_id/Sites/justcar/resources/views/copyright_plans/index.blade.php ENDPATH**/ ?>