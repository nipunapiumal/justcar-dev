...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('assets/theme6/css/custom.css?v=3')); ?>">
...
<body>
    ...
    <div class="wrapper ovh">
        ...
        <?php if($storethemesetting['enable_top_bar'] == 'on'): ?>
            <!-- header top -->
            <div class="header_top <?php echo e($style_topbar); ?> dn-992">
                <div class="container">
                    <div class="row">
            ...
            <nav>
                <div class="container">
                        ...
                        <?php if(Request::segment(3)): ?>
                            <?php if(!empty($store->logo_dark)): ?>
                                <img width="165px" class="logo1 img-fluid"
                                    ...
                                    alt="<?php echo e($store->logo_dark); ?>">
                                <img width="165px" class="logo2 img-fluid"
                                    src="<?php echo e(asset(Storage::url('uploads/store_logo/' . $store->logo_dark))); ?>"
                                    alt="<?php echo e($store->logo_dark); ?>">
                            <?php else: ?>
                                <img width="165px" class="logo1 img-fluid"
                                    src="<?php echo e(asset(Storage::url('uploads/store_logo/logo.png'))); ?>" alt="logo">
                            <?php endif; ?>
                        <?php else: ?>
                            <?php if(!empty($store->logo)): ?>
                                <img width="165px" class="logo1 img-fluid"
                                    src="<?php echo e(asset(Storage::url('uploads/store_logo/' . $store->logo))); ?>"
                                    alt="<?php echo e($store->logo); ?>">
                                <img width="165px" class="logo2 img-fluid"
                                    src="<?php echo e(asset(Storage::url('uploads/store_logo/' . $store->logo))); ?>"
                                    alt="<?php echo e($store->logo); ?>">
                            <?php else: ?>
                    ...
                    <ul id="respMenu" class="ace-responsive-menu text-end" data-menu-style="horizontal">
                        ...
                        <?php endif; ?>
                        <?php if(Utility::CustomerAuthCheck($store->slug) != true): ?>
                            <li><a href="<?php echo e(route('customer.login', $store->slug)); ?>"><?php echo e(__('Log in')); ?></a></li>
                            <li class="add_listing"><a
                                    href="<?php echo e(route('store.usercreate', $store->slug)); ?>"><?php echo e(__('Register')); ?></a>
                            </li>
                        <?php else: ?>
                        ...
                        <?php if($storethemesetting['enable_email_subscriber'] == 'on'): ?>
                            <div class="col-sm-6 col-md-6 col-lg-3 col-xl-3">
                                <div class="footer_contact_widget">
                                    ...
                                    <?php echo e(Form::open(['route' => ['subscriptions.store_email', $store->id], 'method' => 'POST', 'class' => 'footer_mailchimp_form'])); ?>
...
<?php /**PATH /Users/nippasmac/Sites/justcar-dev/resources/views/storefront/layout/theme6_.blade.php ENDPATH**/ ?>